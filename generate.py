...
def build_history_page():
    ...
    .tl-ev:before{content:"";position:absolute;left:13px;top:8px;width:14px;height:14px;border-radius:9999px;background:var(--ec);border:3px solid #FBF5E9;box-shadow:0 0 0 1.5px var(--ec)}
    ...
    .tl-chips{position:sticky;top:58px;z-index:30;background:linear-gradient(#FBF5E9 82%,rgba(251,245,233,0));scrollbar-width:none;-ms-overflow-style:none}
