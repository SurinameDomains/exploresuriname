...
# Load data from exploresuriname_listings.json (keyed by slug)
_JSON_DESCS:    dict = {}
_JSON_WEBSITES: dict = {}
_JSON_PHONES:   dict = {}
...
if _jd_path.exists():
    try:
        for _e in json.loads(_jd_path.read_text(encoding="utf-8")):
            ...
            if _e.get("website", "").strip():
                _JSON_WEBSITES[_slug] = _e["website"].strip()
            if _e.get("phone", "").strip():
                _JSON_PHONES[_slug] = _e["phone"].strip()
        print(f"  Loaded {len(_JSON_DESCS)} descs, {len(_JSON_WEBSITES)} websites, {len(_JSON_PHONES)} phones from listings JSON")
    except Exception as _err:
...
_BIZ = {
    ...
    '4x4-rental': {"name": '4x4 Rental', "location": 'Paramaribo', "address": 'Albergastraat 38, Zorg en Hoop, Paramaribo', "phone": '+597 851-5376', "website": ''},
    ...
    'auto-style-kwatta': {"name": 'Auto Style Kwatta', "location": 'Wanica', "address": 'Kwatta, Paramaribo', "phone": '', "website": ''},
    ...
    'bingo-pizza-kwatta': {"name": 'Bingo Pizza Kwatta', "location": 'Wanica', "address": 'Paramaribo, Suriname', "phone": '', "website": 'https://www.bingopizza.sr/'},
    ...
    'boekhandel-kasco': {"name": 'Boekhandel KASCO', "location": 'Paramaribo', "address": 'Heerenstraat 25, Paramaribo', "phone": '+597 476-127', "website": 'kasco.online'},
    ...
    'carline-kwatta': {"name": 'Carline Kwatta', "location": 'Wanica', "address": 'Paramaribo, Suriname', "phone": '', "website": ''},
    ...
    'cookie-closet': {"name": 'Cookie Closet', "location": 'Paramaribo', "address": 'Paramaribo, Suriname', "phone": '', "website": ''},    'cpr-pilates-curves': {"name": 'Cpr Pilates Curves', "location": 'Paramaribo', "address": 'Paramaribo, Suriname', "phone": '', "website": ''},
    ...
    'fatum-schadeverzekering-kwatta': {"name": 'FATUM Kwatta', "location": 'Wanica', "address": 'Kwatta, Paramaribo', "phone": '', "website": ''},
    ...
    'furniture-city-kwatta': {"name": 'Furniture City Kwatta', "location": 'Wanica', "address": 'Kwatta, Paramaribo', "phone": '', "website": ''},
    ...
    'kasco-customs-solutions': {"name": 'KASCO Custom Solutions', "location": 'Paramaribo', "address": 'Paramaribo, Suriname', "phone": '', "website": 'kascocustomssolutions.com'},
    ...
    'kfc-kwatta': {"name": 'KFC Kwatta', "location": 'Wanica', "address": 'Kwatta, Paramaribo', "phone": '', "website": ''},
    ...
    'mn-international-kwatta': {"name": 'MN International Kwatta', "location": 'Wanica', "address": 'Paramaribo, Suriname', "phone": '', "website": ''},
    ...
    'naskip-4': {"name": 'Naskip Kwatta', "location": 'Wanica', "address": 'Hoek Kwattaweg & Van Idsingastraat, Paramaribo', "phone": '', "website": 'https://www.naskip.com/'},
    ...
    'pandie': {"name": 'Pandie', "location": 'Paramaribo', "address": 'Atlasstraat 40, Paramaribo', "phone": '', "website": 'www.ilovepandie.com'},
    ...
    'red-century-party-shop-commewijne': {"name": 'Red Century Party Shop Commewijne', "location": 'Commewijne', "address": 'Paramaribo, Suriname', "phone": '', "website": ''},
    'red-century-party-shop-kwatta': {"name": 'Red Century Party Shop Kwatta', "location": 'Wanica', "address": 'Paramaribo, Suriname', "phone": '', "website": ''},
    'red-century-party-shop-lelydorp': {"name": 'Red Century Party Shop Lelydorp', "location": 'Wanica', "address": 'Paramaribo, Suriname', "phone": '', "website": ''},
    ...
    'rossignol-2go-kwattaweg': {"name": 'Rossignol 2GO Kwattaweg', "location": 'Wanica', "address": 'Kwattaweg, Paramaribo', "phone": '', "website": ''},
    ...
    'southern-commercial-bank': {"name": 'Southern Commercial Bank N.V.', "location": 'Paramaribo', "address": 'Tourtonnelaan 33, Paramaribo', "phone": '', "website": 'www.scombank.sr'},
    ...
    'subway': {"name": 'Subway (Lalla Rookhweg)', "location": 'Paramaribo', "address": 'Lalla Rookhweg 79, Paramaribo', "phone": '+597 810-1414', "website": ''},
    'subway-2': {"name": 'Subway (Jozef Israëlsstraat)', "location": 'Paramaribo', "address": 'Jozef Israëlsstraat, Paramaribo', "phone": '', "website": ''},
    'subway-3': {"name": 'Subway (Kwattaweg)', "location": 'Wanica', "address": 'Kwattaweg 428a, Paramaribo', "phone": '', "website": ''},
...
_IMGS = {
    ...
    '9173': 'images/listings/9173.jpg',
    'a-la-john': 'images/listings/a-la-john.jpg',
    'aaras-cafe': 'https://socialsuriname.com/wp-content/uploads/2025/05/Aaras-Cafe-v1.webp',
    'ac-bar-restaurant': 'images/listings/ac-bar-restaurant.jpg',
    ...
    'afobaka-resort': 'images/listings/afobaka-resort.jpg',
    'akira-overwater-resort': 'images/listings/akira-overwater-resort.jpg',
    ...
    'anaula-nature-resort': 'https://anaulanatureresort.com/wp-content/uploads/2022/11/ANAULA-2022-86.jpg',
    'anton-de-kom-universiteit-van-suriname': 'https://www.uvs.edu/wp-content/uploads/2024/10/DSC_5883.jpg',
    'ashley-furniture-homestore': 'https://ashley.biz/wp-content/uploads/2024/09/Paramaribo-Suriname.webp',
    'assuria-hermitage-high-rise': 'https://www.assuria.sr/assets/logos/assuria_verzekeringen.png',
    'assuria-insurance-walk-in-city': 'https://www.assuria.sr/assets/logos/assuria_verzekeringen.png',
    'assuria-insurance-walk-in-commewijne': 'https://www.assuria.sr/assets/logos/assuria_verzekeringen.png',
    'assuria-insurance-walk-in-lelydorp': 'https://www.assuria.sr/assets/logos/assuria_verzekeringen.png',
    'assuria-insurance-walk-in-nickerie': 'https://www.assuria.sr/assets/logos/assuria_verzekeringen.png',
    'assuria-insurance-walk-in-noord': 'https://www.assuria.sr/assets/logos/assuria_verzekeringen.png',
    'atlantis-hotel-casino': 'https://cdn.worldota.net/t/640x400/carsolize/b3/24/b324236031e85da32c1c0dab08b16a324ca7c0f0.jpeg',
    'augis-travel': 'https://www.surinamyp.com/img/sr/c/_1684146589-39-augi-s-travel-buro.jpg',
    'auto-style-franchepanestraat': 'https://www.surinamyp.com/img/sr/b/1683529536-94-auto-style.jpg',
    'auto-style-johannes-mungrastraat': 'https://www.surinamyp.com/img/sr/b/1683529536-94-auto-style.jpg',
    'auto-style-kwatta': 'https://www.surinamyp.com/img/sr/b/1683529536-94-auto-style.jpg',
    'auto-style-tweede-rijweg': 'https://www.surinamyp.com/img/sr/b/1683529536-94-auto-style.jpg',
    'auto-style-verlengde-gemenelandsweg': 'https://www.surinamyp.com/img/sr/b/1683529536-94-auto-style.jpg',
    ...
    'baka-foto-restaurant': 'images/listings/baka-foto-restaurant.jpg',
    'bar-zuid': 'images/listings/bar-zuid.jpg',
    'bed-bath-more-bbm': 'images/listings/bed-bath-more-bbm.jpg',
    ...
    'bingo-pizza-coppename': 'https://www.surinamyp.com/img/sr/e/1683634296-82-bingo-pizza.jpg',
    'bingo-pizza-kwatta': 'https://www.surinamyp.com/img/sr/e/1683634296-82-bingo-pizza.jpg',
    ...
    'bitdynamics': 'images/listings/bitdynamics.jpg',
    'bloom-wellness-cafe': 'images/listings/bloom-wellness-cafe.jpg',
    ...
    'bori-tori': 'images/listings/bori-tori.jpg',
    ...
    'bronbella-villa-residence': 'images/listings/bronbella-villa-residence.jpg',
    ...
    'carpe-diem-massagepraktijk': 'images/listings/carpe-diem-massagepraktijk.jpg',
    ...
    'chi-min': 'images/listings/chi-min.jpg',
    ...
    'clevia-park': 'https://cleviapark.sr/wp-content/uploads/2024/08/LOGOs_-CP-300x143.png',
    'coffee-mama': 'https://cdn.shopify.com/s/files/1/0818/3732/6683/files/logo_coffee_mama_small_001_png.png',
    'cola-kreek-recreatiepark': 'images/listings/cola-kreek-recreatiepark.jpg',
    ...
    'courtyard-by-marriott': 'images/listings/courtyard-by-marriott.webp',
    ...
    'danpaati-river-lodge': 'https://surinameholidays.nl/wp-content/uploads/2019/07/Suriname-Holidays_Danpaati-River-Lodge.jpg',
    ...
    'de-spot': 'images/listings/de-spot.jpg',
    'de-surinaamsche-bank-hermitage-mall': 'https://www.dsb.sr/assets/logo-desktop.svg',
    'de-surinaamsche-bank-hoofdkantoor': 'https://www.dsb.sr/assets/logo-desktop.svg',
    'de-surinaamsche-bank-lelydorp': 'https://www.dsb.sr/assets/logo-desktop.svg',
    'de-surinaamsche-bank-ma-retraite': 'https://www.dsb.sr/assets/logo-desktop.svg',
    'de-surinaamsche-bank-ma-retraite-2': 'https://www.dsb.sr/assets/logo-desktop.svg',
    'de-surinaamsche-bank-nickerie': 'https://www.dsb.sr/assets/logo-desktop.svg',
    'de-surinaamsche-bank-nickerie-2': 'https://www.dsb.sr/assets/logo-desktop.svg',
    'de-surinaamsche-bank-nieuwe-haven': 'https://www.dsb.sr/assets/logo-desktop.svg',
    'de-verdieping': 'images/listings/de-verdieping.jpg',
    'delete-beauty-lounge': 'images/listings/delete-beauty-lounge.jpg',
    'deto-handelmaatschappij': 'https://socialsuriname.com/wp-content/uploads/2024/06/deto-v1.webp',
    'digicel-albina': 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Digicel_logo.svg/1280px-Digicel_logo.svg.png',
    'digicel-business-center': 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Digicel_logo.svg/1280px-Digicel_logo.svg.png',
    'digicel-extacy': 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Digicel_logo.svg/1280px-Digicel_logo.svg.png',
    'digicel-hermitage': 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Digicel_logo.svg/1280px-Digicel_logo.svg.png',
    'digicel-latour': 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Digicel_logo.svg/1280px-Digicel_logo.svg.png',
    'digicel-lelydorp': 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Digicel_logo.svg/1280px-Digicel_logo.svg.png',
    'digicel-nickerie': 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Digicel_logo.svg/1280px-Digicel_logo.svg.png',
    'digicel-wilhelminastraat': 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Digicel_logo.svg/1280px-Digicel_logo.svg.png',
    'digital-world-hermitage-mall': 'https://cms.digitalworld.sr/assets/a0b4f195-fab0-4eca-a0f3-bd980e1c3fe4/OG%20Image.png?cache=20240315',
    'digital-world-ims': 'https://cms.digitalworld.sr/assets/a0b4f195-fab0-4eca-a0f3-bd980e1c3fe4/OG%20Image.png?cache=20240315',
    'digital-world-maretraite-mall': 'https://cms.digitalworld.sr/assets/a0b4f195-fab0-4eca-a0f3-bd980e1c3fe4/OG%20Image.png?cache=20240315',
    'digital-world-maretraite-mall-2': 'https://cms.digitalworld.sr/assets/a0b4f195-fab0-4eca-a0f3-bd980e1c3fe4/OG%20Image.png?cache=20240315',
    'divergent-body-jewelry': 'images/listings/divergent-body-jewelry.jpg',
    'dj-liquor-store': 'images/listings/dj-liquor-store.jpg',
    'dli-travel-consultancy': 'images/listings/dli-travel-consultancy.jpg',
    'dojo-couture-centrum': 'https://www.surinamyp.com/img/sr/c/1683546527-60-dojo-couture.jpg',
    'dojo-couture-hermitage-mall': 'https://www.surinamyp.com/img/sr/c/1683546527-60-dojo-couture.jpg',
    'dojo-couture-ims': 'https://www.surinamyp.com/img/sr/c/1683546527-60-dojo-couture.jpg',
    ...
    'eaglemedia': 'images/listings/eaglemedia.jpg',
    'ec-operations': 'images/listings/ec-operations.jpg',
    'eco-resort-miano': 'images/listings/eco-resort-miano.webp',
    'eco-torarica': 'images/listings/eco-torarica.jpg',
    'eethuis-liv': 'https://socialsuriname.com/wp-content/uploads/2025/11/Eethuis-Liv-v1.webp',
    'ekay-media': 'images/listings/ekay-media.jpg',
    'el-patron-latin-grill': 'images/listings/el-patron-latin-grill.jpg',
    'elines-pizza': 'images/listings/elines-pizza.jpg',
    ...
    'fatum': 'images/listings/fatum.jpg',
    ...
    'finabank-centrum': 'https://www.finabanknv.com/ysimg/finabank_logo.png',
    'finabank-nickerie': 'https://www.finabanknv.com/ysimg/finabank_logo.png',
    'finabank-noord': 'https://www.finabanknv.com/ysimg/finabank_logo.png',
    'finabank-wanica': 'https://www.finabanknv.com/ysimg/finabank_logo.png',
    'finabank-zuid': 'https://www.finabanknv.com/ysimg/finabank_logo.png',
    ...
    'fly-allways': 'images/listings/fly-allways.jpg',
    ...
    'ford-zeelandia': 'images/listings/ford-zeelandia.jpg',
    'from-me-to-me': 'images/listings/from-me-to-me.webp',
    ...
    'galaxy': 'images/listings/galaxy.jpg',
    ...
    'garden-of-eden': 'images/listings/garden-of-eden.jpg',
    'georgies-bar-chill': 'https://socialsuriname.com/wp-content/uploads/2024/06/Georgies-Bar-Chill.webp',
    'goe-thai-noodle-bar': 'images/listings/goe-thai-noodle-bar.jpg',
    ...
    'greenheart-boutique-hotel': 'https://cdn.worldota.net/t/640x400/content/32/93/3293ffd8f50bd67e323bbab52f137449e528ca3c.jpeg',
    'guesthouse-albergoalberga': 'https://cdn.worldota.net/t/640x400/content/8f/15/8f156454c55935eb886f10af973ed88cdf41745d.jpeg',
    'h-garden': 'images/listings/h-garden.png',
    'hairstudio-32': 'images/listings/hairstudio-32.webp',
    'hakrinbank': 'https://www.hakrinbank.com/app/uploads/2024/01/logo.png',
    'hakrinbank-flora': 'https://www.hakrinbank.com/app/uploads/2024/01/logo.png',
    'hakrinbank-latour': 'https://www.hakrinbank.com/app/uploads/2024/01/logo.png',
    'hakrinbank-nickerie': 'https://www.hakrinbank.com/app/uploads/2024/01/logo.png',
    'hakrinbank-nieuwe-haven': 'https://www.hakrinbank.com/app/uploads/2024/01/logo.png',
    'hakrinbank-tamanredjo': 'https://www.hakrinbank.com/app/uploads/2024/01/logo.png',
    'hakrinbank-tourtonne': 'https://www.hakrinbank.com/app/uploads/2024/01/logo.png',
    'handmade-by-farrell-nv': 'images/listings/handmade-by-farrell-nv.jpg',
    'hard-rock-cafe-suriname': 'images/listings/hard-rock-cafe-suriname.jpg',
    'hermitage-mall': 'images/listings/hermitage-mall.jpg',
    'het-koto-museum': 'images/listings/het-koto-museum.jpg',
    'holiday-home-decor': 'https://socialsuriname.com/wp-content/uploads/2025/07/Holiday-Home-Decor-v2.webp',
    'holland-lodge': 'images/listings/holland-lodge.jpg',
    ...
    'honeycare': 'images/listings/honeycare.jpg',
    'honeycare-north': 'https://www.honeycaresu.com/wp-content/uploads/2022/04/landingpagelogo-332x142.png',
    'honeycare-south': 'https://www.honeycaresu.com/wp-content/uploads/2022/04/landingpagelogo-332x142.png',
    ...
    'hotel-palacio': 'images/listings/hotel-palacio.jpg',
    'hotel-peperpot': 'images/listings/hotel-peperpot.jpg',
    'houttuyn-wellness-river-resort': 'images/listings/houttuyn-wellness-river-resort.jpg',
    'huub-explorer-tours': 'images/listings/huub-explorer-tours.jpg',
    'iamchede': 'https://socialsuriname.com/wp-content/uploads/2025/10/Iamchede-v1.webp',
    'ias-wooden-and-construction-nv': 'images/listings/ias-wooden-and-construction-nv.png',
    'ineffable': 'images/listings/ineffable.webp',
    'inksane-tattoos': 'images/listings/inksane-tattoos.jpg',
    'instyle-optics': 'https://www.instyle.sr/wp-content/uploads/2024/03/instyle-logo-200px.png',
    'international-mall-of-suriname': 'images/listings/international-mall-of-suriname.jpg',
    ...
    'jacana-amazon-wellness-resort': 'images/listings/jacana-amazon-wellness-resort.jpg',
    ...
    'jage-caffe': 'https://socialsuriname.com/wp-content/uploads/2024/08/Jage-Caffe-Gompertstraat-v1.webp',
    ...
    'joden-savanne': 'images/listings/joden-savanne.jpg',
    'joey-ds': 'images/listings/joey-ds.jpg',
    'joosje-roti-shop': 'https://www.surinamyp.com/img/sr/z/1683543876-37-joosje-roti-shop.jpg',
    'julias-food': 'images/listings/julias-food.jpg',
    'kabalebo-nature-resort': 'https://kabalebo.com/wp-content/uploads/2025/03/logo-no-space.png',
    'karans-indian-food': 'https://socialsuriname.com/wp-content/uploads/2024/06/Karans-Indian-Food-v1.webp',
    'kasan-snacks': 'images/listings/kasan-snacks.jpg',
    ...
    'kirpalani': 'images/listings/kirpalani.webp',
    'kirpalani-domineestraat': 'https://www.surinamyp.com/img/sr/e/1683222276-81-kirpalani-s-nv-warenhuis.jpg',
    'kirpalani-maagdenstraat': 'https://www.surinamyp.com/img/sr/e/1683222276-81-kirpalani-s-nv-warenhuis.jpg',
    'kirpalani-super-store': 'https://www.surinamyp.com/img/sr/e/1683222276-81-kirpalani-s-nv-warenhuis.jpg',
    'klm-royal-dutch-airlines': 'images/listings/klm-royal-dutch-airlines.jpg',
    'knini-paati': 'images/listings/knini-paati.jpg',
    'kodouffi-tapawatra-resort': 'images/listings/kodouffi-tapawatra-resort.jpg',
    ...
    'las-tias': 'images/listings/las-tias.jpg',
    'lashlift-suriname': 'images/listings/lashlift-suriname.jpg',
    ...
    'lilis': 'images/listings/lilis.webp',
    'lioness-beauty-effects': 'images/listings/lioness-beauty-effects.jpg',
    ...
    'mcdonalds-centrum': 'https://www.mcdonalds.com/content/dam/sites/usa/nfl/icons/McD_GoldenArches_200x200.jpg',
    'mcdonalds-hermitage-mall': 'https://www.mcdonalds.com/content/dam/sites/usa/nfl/icons/McD_GoldenArches_200x200.jpg',
    'mickis-palace-noord': 'images/listings/mickis-palace-noord.jpg',
    'mickis-palace-zuid': 'images/listings/mickis-palace-zuid.jpg',
    'mimi-market': 'https://socialsuriname.com/wp-content/uploads/2024/06/Mimi-Market-v1.webp',
    'mingle-paramaribo': 'images/listings/mingle-paramaribo.jpg',
    'mingle-sushi': 'https://socialsuriname.com/wp-content/uploads/2024/08/Mingle-Sushi-Bar-v4.webp',
    'miniso-gompertstraat': 'https://mallsbycountry.com/images/stores/hermitage-mall/miniso-suriname-logo.jpg',
    'miniso-hermitage-mall': 'https://mallsbycountry.com/images/stores/hermitage-mall/miniso-suriname-logo.jpg',
    ...
    'mokisa-busidataa-osu-nv': 'images/listings/mokisa-busidataa-osu-nv.jpg',
    'moments-restaurant': 'images/listings/moments-restaurant.jpg',
    ...
    'murphys-irish-pub': 'https://socialsuriname.com/wp-content/uploads/2024/06/Murphys-Irish-Pub.webp',
    'museum-bakkie': 'images/listings/museum-bakkie.jpg',
    ...
    'nv-threefold-quality-system-support': 'images/listings/nv-threefold-quality-system-support.jpg',
    'nv-zing-manufacturing': 'images/listings/nv-zing-manufacturing.jpg',
    ...
    'optiek-ninon': 'https://optiekninon.net/wp-content/uploads/2023/06/logo-ninon-1.png',
    'optiek-ninon-hermitage-mall': 'https://optiekninon.net/wp-content/uploads/2023/06/logo-ninon-1.png',
    'optiek-ninon-ims': 'https://optiekninon.net/wp-content/uploads/2023/06/logo-ninon-1.png',
    'optiek-ninon-lelydorp': 'https://optiekninon.net/wp-content/uploads/2023/06/logo-ninon-1.png',
    'optiek-ninon-meerzorg': 'https://optiekninon.net/wp-content/uploads/2023/06/logo-ninon-1.png',
    'optiek-ninon-nickerie': 'https://optiekninon.net/wp-content/uploads/2023/06/logo-ninon-1.png',
    'outdoor-living': 'https://socialsuriname.com/wp-content/uploads/2024/06/Outdoor-Living.webp',
    'overbridge-river-resort': 'https://www.surinamyp.com/img/sr/f/1683794441-96-overbridge-river-resort.jpg',
    'oxygen-resort': 'images/listings/oxygen-resort.webp',
    ...
    'pane-e-vino': 'images/listings/pane-e-vino.jpg',
    'pannekoek-en-poffertjes-cafe': 'images/listings/pannekoek-en-poffertjes-cafe.jpg',
    'papillon-crafts': 'images/listings/papillon-crafts.jpg',
    'paramaribo-zoo': 'https://www.paramaribozoo.com/img/logo.jpg',
    'passion-food-and-wines': 'images/listings/passion-food-and-wines.jpg',
    'peperpot-nature-park': 'images/listings/peperpot-nature-park.jpg',
    ...
    'pinkmoon-suriname': 'images/listings/pinkmoon-suriname.jpg',
    ...
    'plantage-frederiksdorp': 'images/listings/plantage-frederiksdorp.jpg',
    ...
    'radisson-hotel': 'https://imgcy.trivago.com/c_fill,d_dummy.jpeg,e_sharpen:60,f_auto,h_627,q_auto,w_1200/partner-images/66/77/8a27159dcf0fef80f2d14d55969250cef5a8e4fc08fb24070b2f57ebc228.jpeg',
    'ramada-paramaribo-princess': 'https://socialsuriname.com/wp-content/uploads/2024/06/Ramada-Paramaribo-Princess.webp',
    'readytex-art-gallery': 'https://www.readytexartgallery.com/wp-content/uploads/2021/04/rag-logo.png',
    'readytex-souvenirs-and-crafts': 'images/listings/readytex-souvenirs-and-crafts.jpg',
    'real-one-fitness-gym': 'https://socialsuriname.com/wp-content/uploads/2025/08/REAL-ONE-Fitness-GYM.webp',
    'recreatie-oord-carolina-kreek': 'images/listings/recreatie-oord-carolina-kreek.jpg',
    'remy-vastgoed': 'https://www.remyvastgoed.com/storage/2023/04/RV-vierkant-1.png',
    'republic-bank-head-office': 'https://republicbanksr.com/sites/default/files/logo.png',
    'republic-bank-jozef-israelstraat': 'https://republicbanksr.com/sites/default/files/logo.png',
    'republic-bank-kernkampweg': 'https://republicbanksr.com/sites/default/files/logo.png',
    'republic-bank-nickerie': 'https://republicbanksr.com/sites/default/files/logo.png',
    'republic-bank-vant-hogerhuysstraat': 'https://republicbanksr.com/sites/default/files/logo.png',
    'republic-bank-zorg-en-hoop': 'https://republicbanksr.com/sites/default/files/logo.png',
    ...
    'rich-skin': 'images/listings/rich-skin.jpg',
    'ricos-a-gladiator-foodtruck': 'https://socialsuriname.com/wp-content/uploads/2025/04/Ricos-v3.webp',
    'rock-fitness-paramaribo': 'images/listings/rock-fitness-paramaribo.jpg',
    'rogom-farm-nv': 'images/listings/rogom-farm-nv.jpg',
    ...
    'royal-brasil-hotel': 'images/listings/royal-brasil-hotel.jpg',
    'royal-breeze-hotel-paramaribo': 'images/listings/royal-breeze-hotel-paramaribo.jpg',
    'royal-rose-yoni-spa': 'images/listings/royal-rose-yoni-spa.jpg',
    'royal-spa': 'images/listings/royal-spa.jpg',
    'royal-torarica': 'images/listings/royal-torarica.webp',
    'royal-tours-suriname-guyana': 'https://img.youtube.com/vi/JbRKcloOTZA/hqdefault.jpg',
    'royal-wellness-lounge': 'images/listings/royal-wellness-lounge.jpg',
    ...
    'savannah-casino-hotel': 'https://cdn.worldota.net/t/640x400/content/81/48/814832a6badf3c8c47c15ceafae1f0ac51a0c34e.jpeg',
    'seen-stories': 'images/listings/seen-stories.jpg',
    'sendang-redjo': 'https://socialsuriname.com/wp-content/uploads/2025/10/Sendang-Redjo-v6.webp',
    'shlx-collection': 'images/listings/shlx-collection.jpg',
    'shoebizz-ims': 'https://ims.sr/wp-content/uploads/2023/09/shoebizz_office-300x188.jpg',
    ...
    'souposo': 'images/listings/souposo.jpg',
    'southern-commercial-bank': 'https://scombank.sr/wp-content/uploads/2021/10/logo-scomm.webp',
    ...
    'sranan-fowru': 'https://www.surinamyp.com/img/sr/x/1683531944-12-sranan-fowru-n-v.jpg',
    'sranan-fowru-boni': 'https://www.surinamyp.com/img/sr/x/1683531944-12-sranan-fowru-n-v.jpg',
    'sranan-fowru-combe': 'https://www.surinamyp.com/img/sr/x/1683531944-12-sranan-fowru-n-v.jpg',
    'sranan-fowru-flu': 'https://www.surinamyp.com/img/sr/x/1683531944-12-sranan-fowru-n-v.jpg',
    'sranan-fowru-leiding': 'https://www.surinamyp.com/img/sr/x/1683531944-12-sranan-fowru-n-v.jpg',
    'sranan-fowru-lelydorp': 'https://www.surinamyp.com/img/sr/x/1683531944-12-sranan-fowru-n-v.jpg',
    'sranan-fowru-meursweg': 'https://www.surinamyp.com/img/sr/x/1683531944-12-sranan-fowru-n-v.jpg',
    'sranan-fowru-tabiki-fowru': 'https://www.surinamyp.com/img/sr/x/1683531944-12-sranan-fowru-n-v.jpg',
    'sranan-fowru-tourtonne': 'https://www.surinamyp.com/img/sr/x/1683531944-12-sranan-fowru-n-v.jpg',
    'sranan-fowru-zinnia': 'https://www.surinamyp.com/img/sr/x/1683531944-12-sranan-fowru-n-v.jpg',
    'steps-domineestraat': 'https://steps.sr/templates/tpl01/img/CDS_logo.png',
    'steps-hermitage-mall': 'https://steps.sr/templates/tpl01/img/CDS_logo.png',
    'steps-noord': 'https://steps.sr/templates/tpl01/img/CDS_logo.png',
    'steps-wanica': 'https://steps.sr/templates/tpl01/img/CDS_logo.png',
    'stichting-shiatsu-massage': 'images/listings/stichting-shiatsu-massage.jpg',
    'stichting-surinaams-museum': 'http://www.surinaamsmuseum.net/wp-content/uploads/2015/07/SurinaamsMuseum-for-web.png',
    ...
    'stukaderen-in-nederland': 'images/listings/stukaderen-in-nederland.jpg',
    'subway': 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Subway_2016_logo.svg/1280px-Subway_2016_logo.svg.png',
    'subway-2': 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Subway_2016_logo.svg/1280px-Subway_2016_logo.svg.png',
    'subway-3': 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Subway_2016_logo.svg/1280px-Subway_2016_logo.svg.png',
    ...
    'suraniyat': 'images/listings/suraniyat.jpg',
    ...
    'surimami-store': 'images/listings/surimami-store.jpg',
    'surinaamsche-waterleiding-maatschappij': 'https://swm.sr/wp-content/uploads/2023/04/swm-logo.png',
    'surinam-airways': 'images/listings/surinam-airways.jpg',
    'sushi-ya': 'images/listings/sushi-ya.jpg',
    'sweetheart-hermitage-mall': 'https://socialsuriname.com/wp-content/uploads/2024/06/Sweetheart-v1.webp',
    'sweetheart-ims': 'https://socialsuriname.com/wp-content/uploads/2024/06/Sweetheart-v1.webp',
    'sweetie-coffee': 'https://socialsuriname.com/wp-content/uploads/2024/06/Sweetie-Coffee.webp',
    'switi-momenti-candles-crafts': 'images/listings/switi-momenti-candles-crafts.jpg',
    'talking-prints-concept-store': 'images/listings/talking-prints-concept-store.jpg',
    'taman-indah-resort': 'images/listings/taman-indah-resort.jpg',
    'tasty-fresh-food-coffee-bar': 'https://www.kirpalani.com/media/wysiwyg/Tasty/cafe_2.webp',
    'tbl-cinemas': 'https://www.tblcinemas.com/assets/img/tbl_logo.png',
    'teasee': 'https://socialsuriname.com/wp-content/uploads/2025/01/Teasee.webp',
    'telesur-centrum': 'https://www.telesur.sr/wp-content/uploads/2024/06/telesur_logo_2x-1.png',
    'telesur-latour': 'https://www.telesur.sr/wp-content/uploads/2024/06/telesur_logo_2x-1.png',
    'telesur-lelydorp': 'https://www.telesur.sr/wp-content/uploads/2024/06/telesur_logo_2x-1.png',
    'telesur-nickerie': 'https://www.telesur.sr/wp-content/uploads/2024/06/telesur_logo_2x-1.png',
    'telesur-noord': 'https://www.telesur.sr/wp-content/uploads/2024/06/telesur_logo_2x-1.png',
    'telesur-zonnebloemstraat': 'https://www.telesur.sr/wp-content/uploads/2024/06/telesur_logo_2x-1.png',
    'the-beauty-bar': 'images/listings/the-beauty-bar.jpg',
    ...
    'the-coffee-box': 'images/listings/the-coffee-box.jpg',
    ...
    'the-freelance-scout': 'images/listings/the-freelance-scout.webp',
    'the-golden-truly-hotel': 'images/listings/the-golden-truly-hotel.jpg',
    'the-house-of-beauty': 'images/listings/the-house-of-beauty.webp',
    'the-maillard-cafe': 'https://socialsuriname.com/wp-content/uploads/2025/04/The-maillard-cafe-v1.webp',
    'the-old-attic': 'images/listings/the-old-attic.jpg',
    'the-rose-manor': 'https://socialsuriname.com/wp-content/uploads/2025/03/The-Rose-Manor.webp',
    'the-uma-store': 'images/listings/the-uma-store.jpg',
    'the-waxing-booth': 'images/listings/the-waxing-booth.jpg',
    'the-wonderlab-su': 'images/listings/the-wonderlab-su.jpg',
    'theater-thalia': 'https://theaterthalia.com/wp-content/uploads/2023/04/thalia-theater-suriname.jpg',
    'thermen-hermitage-turkish-bath-beautycenter': 'images/listings/thermen-hermitage-turkish-bath-beautycenter.jpg',
    'tianyou-aquafun': 'https://img.youtube.com/vi/cWIBzH1WVvQ/hqdefault.jpg',
    'timeless-barber-and-nail-shop': 'images/listings/timeless-barber-and-nail-shop.jpg',
    'tiny-house-tropical-appartment': 'images/listings/tiny-house-tropical-appartment.jpg',
    'tio-boto-eco-resort': 'images/listings/tio-boto-eco-resort.jpg',
    ...
    'torarica-resort': 'images/listings/torarica-resort.jpg',
    'tropicana-hotel-casino-suriname': 'https://cdn.worldota.net/t/640x400/content/b6/af/b6af2af7424c164241feca4cea52cfce5f95ce67.jpeg',
    ...
    'unlimited-suriname-tours': 'images/listings/unlimited-suriname-tours.jpg',
    'unlocked-candles': 'images/listings/unlocked-candles.jpg',
    'vcm-slagerij-centrum': 'https://winkel.vcm.sr/wp-content/uploads/2022/03/logo_transp.png',
    'vcm-slagerij-johannes-mungrastraat': 'https://winkel.vcm.sr/wp-content/uploads/2022/03/logo_transp.png',
    'vcm-slagerij-verl-gemenelandsweg': 'https://winkel.vcm.sr/wp-content/uploads/2022/03/logo_transp.png',
    'vifa-trading': 'https://socialsuriname.com/wp-content/uploads/2024/06/Vifa-Trading-v1.webp',
    'villa-famiri': 'images/listings/villa-famiri.jpg',
    ...
    'waterland-suites': 'images/listings/waterland-suites.jpg',
    'wayfinders-exclusive-n-v': 'images/listings/wayfinders-exclusive-n-v.jpg',
    'welink-real-estate': 'https://welink.sr/wp-content/uploads/2024/11/1-1-850x550.jpeg',
    'wollys': 'http://wollys.com/wp-content/uploads/2014/11/Logo-Wollys-kevelle-redo-193x149.png',
    'wollys-2': 'http://wollys.com/wp-content/uploads/2014/11/Logo-Wollys-kevelle-redo-193x149.png',
    'wollys-3': 'http://wollys.com/wp-content/uploads/2014/11/Logo-Wollys-kevelle-redo-193x149.png',
    'woodwonders-suriname': 'images/listings/woodwonders-suriname.jpg',
    'yoga-peetha-happiness-centre': 'images/listings/yoga-peetha-happiness-centre.jpg',
    'yokohama-trading': 'https://socialsuriname.com/wp-content/uploads/2024/06/Yokohama-Trading-NV-v1.webp',
    'zeelandia-suites': 'images/listings/zeelandia-suites.jpg',
    'zeepfabriek-joab': 'images/listings/zeepfabriek-joab.webp',
    'zeg-ijsje': 'images/listings/zeg-ijsje.png',
    'zus-zo-cafe': 'images/listings/zus-zo-cafe.jpg',
}
...
def _make_biz(slug):
    ...
    return {"slug": slug, "name": b["name"], "area": b.get("location", "Suriname"),
            ...
            "phone":    b.get("phone")   or fsq.get("phone")   or _JSON_PHONES.get(slug, ""),
            "email":    b.get("email", ""),
            "website":  b.get("website") or fsq.get("website") or _JSON_WEBSITES.get(slug, ""),
...
SERVICES = [b for slug in ["101-real-estate","4r-gym","4x4-rental","abrix-cleaning-services","access-suriname-travel","alegria","alis-drugstore","alliance-francaise","anton-de-kom-universiteit-van-suriname","apotheek-joemmanbaks","apotheek-karis","apotheek-mac-donald-north","apotheek-mac-donald-south","apotheek-rafeka","apotheek-sibilo","apotheek-soma","apotheek-soma-ringweg","arthur-alex-hoogendoorn-atheneum","assuria-hermitage-high-rise","assuria-insurance-walk-in-city","assuria-insurance-walk-in-commewijne","assuria-insurance-walk-in-lelydorp","assuria-insurance-walk-in-nickerie","assuria-insurance-walk-in-noord","augis-travel","ayur-mi-beauty-wellness","balance-studio","balletschool-marlene","best-mart","bitdynamics","blissful-massage-aromatherapy","blossom-beauty-bar","bmw-suriname","body-enhancement-gym","brahma-centrum","brahma-noord","brahma-zuid","bright-cleaning","brilleman","brotherhood-security","brow-bliss-lounge","buro-workspaces","byd-suriname","camex-suriname","car-rental-city","carline-kwatta","carline-waaldijkstraat","carpe-diem-massagepraktijk","carvision-paramaribo","chique-eyewear-fashion","ciranos","clarissa-vaseur-writing-wellness-services-claw","clean-it","club-oase","cpr-pilates-curves","creative-q","curl-babes","cute-as-a-button","cynsational-glam","da-select-en-service-apotheek","dansclub-danzson","dcars-rental","de-cederboom-school","de-nederlandse-basisschool-het-kleurenorkest","de-spetter","de-surinaamsche-bank-hermitage-mall","de-surinaamsche-bank-hoofdkantoor","de-surinaamsche-bank-lelydorp","de-surinaamsche-bank-ma-retraite","de-surinaamsche-bank-ma-retraite-2","de-surinaamsche-bank-nickerie","de-surinaamsche-bank-nickerie-2","de-surinaamsche-bank-nieuwe-haven","de-vrije-school","delete-beauty-lounge","dhl-express-service-point","dierenarts-resopawiro","dierenartspraktijk-l-m-bansse-issa","dierenpoli-lobo","digicel-albina","digicel-business-center","digicel-extacy","digicel-hermitage","digicel-latour","digicel-lelydorp","digicel-nickerie","digicel-wilhelminastraat","djinipi-copy-center","djo-cleaning-service","dli-travel-consultancy","dojo-couture-centrum","dojo-couture-ims","dor-property-management-services-n-v","dream-clean-suriname","dresscode","eaglemedia","ec-operations","ekay-media","energiebedrijven-suriname-ebs","eterno","eucon","everything-sr","faraya-medical-center","farma-vida","fatum","fatum-schadeverzekering-commewijne","fatum-schadeverzekering-hoofdkantoor","fatum-schadeverzekering-kwatta","fatum-schadeverzekering-nickerie","fhr-lim-a-po-institute-for-higher-education","finabank-centrum","finabank-nickerie","finabank-noord","finabank-wanica","finabank-zuid","first-aid-plus","fish-finder-fishing-and-outdoors","fit-factory","flex-luxuries","fluxo-pilates","fly-allways","free-flow","gaby-april-beauty-clinic","galaxyliving","garage-d-a-ashruf","glam-curves","glambox","gossip-nails-xx","great-wall-motor-suriname","grounded-botanical-studio","h-t","hairstudio-32","hakrinbank","hakrinbank-flora","hakrinbank-latour","hakrinbank-nickerie","hakrinbank-nieuwe-haven","hakrinbank-tamanredjo","hakrinbank-tourtonne","handmade-by-farrell-nv","happy-flower-services","harry-tjin","hertz-suriname-car-rental","hes-ds","hes-ds-2","hes-ds-3","holiday-home-decor","honeycare-north","honeycare-south","house-of-pureness","hsds-lifestyle-noord","hsds-lifestyle-wanica","iamchede","ias-wooden-and-construction-nv","infinity-holding","inksane-tattoos","instyle-optics","international-academy-of-suriname","intervast","invictus-brazilian-jiu-jitsu","itrendzz","jamilas-dry-cleaning-north","jamilas-dry-cleaning-south","janelles-shoes-and-bags","jjs-place-zuid","just-curlss","kaizen","kasco-customs-solutions","kasimex-indira-ghandiweg","kasimex-makro","keller-williams-suriname","kempes-co","klm-royal-dutch-airlines","ladybug-nursery-and-garden-center","lashlift-suriname","le-den","lioness-beauty-effects","lobby","luxe-escape-lotus-spa-wellness-beautysalon","mandy-butka","marchand-notariaat","max-n-co","maze","mighty-racks","mini-nail-shop","mirage-casino","miss-doll-fit","mn-international-centrum","mn-international-kwatta","mokisa-busidataa-osu-nv","mokisa-wellness","mon-plaisir-nursery","morevans-outlet","multi-travel","nassy-brouwer-college","nassy-brouwer-school","new-choice-lalla-rookhweg","new-choice-nickerie","new-choice-ringweg","north-fitness-gym","notariaat-mannes","notariaat-van-dijk","nv-threefold-quality-system-support","ondernemershuis","one-stop-apotheek-drugstore","orchid","organic-skincare","padel-x-suriname","pandie","paramaribo-princess-casino","percy-massage-therapy","pinkmoon-suriname","pitbull-fitness","professional-private-security","protrade-international","qsi-international-school-of-suriname","re-max-suriname","real-one-fitness-gym","red-century-party-shop-commewijne","red-century-party-shop-kwatta","red-century-party-shop-lelydorp","red-century-party-shop-north","red-century-party-shop-zorg-en-hoop","remy-vastgoed","republic-bank-head-office","republic-bank-jozef-israelstraat","republic-bank-kernkampweg","republic-bank-nickerie","republic-bank-vant-hogerhuysstraat","republic-bank-zorg-en-hoop","resourceful-real-estate-construction","rich-skin","rif-cleaning-service","rock-fitness-paramaribo","ross-rental-cars","royal-rose-yoni-spa","royal-spa","royal-wellness-lounge","safety-first-quality-always","satyam-holidays","savage-den","scene-beauty-salon","secas","seen-stories","shimmery-beauty-lounge","shoebizz-ims","sleepstore-suriname","smart-connexxionz","southern-commercial-bank","squeaky-clean","steps-domineestraat","steps-noord","steps-wanica","sthephany-skincare","stichting-shiatsu-massage","store4u","stukaderen-in-nederland","sun-ice","supply-solutions-limited-suriname","surgoed-makelaardij","surimami-store","surinaamsche-waterleiding-maatschappij","surinam-airways","suriname-princess-casino","sweet-tooth-pastries","telesur-centrum","telesur-latour","telesur-lelydorp","telesur-nickerie","telesur-noord","telesur-zonnebloemstraat","the-aerial-yoga-studio","the-basement-barbershop","the-beauty-bar","the-beauty-bar-north","the-beauty-bar-south","the-freelance-scout","the-house-of-beauty","the-laundry-spot","the-nail-house","the-old-garage","the-perfume-spot","the-rose-manor","the-solution-property-management","the-warehouse-shop","the-waxing-booth","the-wonderlab-su","thermen-hermitage-turkish-bath-beautycenter","tianyou-aquafun","timeless-barber-and-nail-shop","topsport","touch-of-heaven-wellness","toys-n-more","tranquil-at-mamba-republiek","tranquil-massage","tsw-group","typing-nomad-nv","waldos-worldwide-travel-service","welink-real-estate","wow-plus","x-avenue","ying-hao-beautyshop","yoga-peetha-happiness-centre","yogh-hospitality","young-engineers","zenobia-bottling-company"] for b in [_make_biz(slug)] if b]
