...
_IMGS = {
    '4x4-rental': 'https://exploresuriname.com/images/4x4-rental.webp',
    ...
    'apotheek-sibilo': 'https://apotheeksibilo.com/wp-content/uploads/elementor/thumbs/3-p49ki4c1iycfrhvjt8hwt18ke9g6rn1kwf6pnwhp90.png',
    ...
    'bloom-wellness-cafe': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/304927764_107824752066501_7292221203492184991_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=101&ccb=1-7&_nc_sid=f907e8&_nc_ohc=mYEOmJf0aFsQ7kNvwEkbMz8&_nc_oc=AdptcXdz6qYd0nEo157Yt4hxHjWUP0QX6l3Be_W290ow7ljc81vZRvNk3QY_3D4rCP0&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=Uqs1MJasa7pa7P8AYb9dgA&oh=00_Af6vunXxAq2H4DlpHLS-xKaj9QNTTHvee6i3_-rTsrKO2A&oe=6A1C669D',
    ...
    'chuck-e-cheese': 'https://www.chuckecheese.com/wp-content/uploads/2026/04/ChuckECheeseLogo-1024x1024.jpg',
    ...
    'dansclub-danzson': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/305396192_515570687237514_7145934113557809101_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=107&ccb=1-7&_nc_sid=f907e8&_nc_ohc=TXqhO6BYgv8Q7kNvwF4glZ4&_nc_oc=AdpkVAzrp-G5tAcZe49MByALkof1NZ2t65JIHwG3fRM2SduzfJdLHQ2eddnXVSaJ_2M&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=tZA_2fp2KQSRUbGdFdOrGw&oh=00_Af42QmvcdyvKIcCs2chCg1_56_rJ3lFOQiDGAI7oHUiIdA&oe=6A1C376D',
    ...
    'elev8te': 'https://exploresuriname.com/images/elev8te.webp',
    ...
    'eterno': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/596179824_1439363764864914_8795267892956429984_n.jpg?stp=cp1_dst-jpg_s200x200_tt6&_nc_cat=103&ccb=1-7&_nc_sid=f907e8&_nc_ohc=nA6EgkRnLJIQ7kNvwHOg44b&_nc_oc=AdrqPeXgLvRj4Qtfuiq0DoIiokP6ySELuLDZpagzhPpWSYVZ0JvLEfVm2PYIjoJyW0Q&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=TZAiZMas7ByMPy2XamK4Hw&oh=00_Af6J0cG2Q8rMkuSCdaJ97nMt1nzxAuOsnIsYQifqxV1fDg&oe=6A1C3991',
    ...
    'fhr-lim-a-po-institute-for-higher-education': 'https://www.fhrinstitute.sr/wp-content/uploads/2025/04/master-1.jpg',
    ...
    'fit-factory': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/240840282_557374195688914_4285084212273525332_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=102&ccb=1-7&_nc_sid=f907e8&_nc_ohc=FsTucBK-hpkQ7kNvwHzu2nh&_nc_oc=AdpzU-a3P39-lFSaJOrxLOtRahoh6c7SPO6k4a_wYBQ2aEQfK6vkpbCBPv_3ZuR4VxE&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=LocVo9Ta3FOm_ilFCAEzog&oh=00_Af5n5rzA6_7crjePPMlOmPw1bkQfUu5Z0QVX4efxiQ-zfg&oe=6A1C5357',
    ...
    'goldenwings': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/326213287_993494784964120_1416981208817456510_n.jpg?stp=dst-jpg_p200x200_tt6&_nc_cat=104&ccb=1-7&_nc_sid=f907e8&_nc_ohc=SG8lYyqNF4sQ7kNvwEfpHB4&_nc_oc=Adr441YZpEriaa1LeJ6EAh-Vnlk15-PJ-pDxceRMVbicgi5cePabu-K-RQ6klgXKrWc&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=ef9IQTcIVC6mUZnIA0hpeg&oh=00_Af5cuvxKyab_s_v0PfkUgrRVGICbQD7JArhh7KVVIcoIww&oe=6A1C4BCC',
    ...
    'han-palace': 'https://exploresuriname.com/images/han-palace.webp',
    ...
    'hertz-suriname-car-rental': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/360092399_108361048994187_1605386901656727548_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=100&ccb=1-7&_nc_sid=f907e8&_nc_ohc=OA74iywNbnIQ7kNvwHIIAnu&_nc_oc=AdoL_yDI5QPSGXqOoY6PKMdKnB0oSL4Bqkk-Ju264BLCV-mgvBXcYDkSNt1wGSkWtJI&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=SdJ5PH88II7D9EBaETVEjg&oh=00_Af4G-fAsRVFTg32Jv7bVURnBrEASUO6EkN6g8l0uSV2Cfg&oe=6A1C3F63',
    ...
    'kaizen': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/315632963_439624795040307_1357632690980774599_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=101&ccb=1-7&_nc_sid=f907e8&_nc_ohc=fO8M-diOV1oQ7kNvwHERXdE&_nc_oc=AdogW9J362ieCCmxXjD3VJ38-qcO8uTDFFhdn1YYWl3mqoWzjVU9VdVxbCyJo8ykrzk&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=Veznhqgls_Weoh0EXTWbsg&oh=00_Af5mUAM9Zec0c_9muMUo_lEdlKfzs8sP44iDMkpU-xbMvw&oe=6A1C59C8',
    ...
    'kodouffi-tapawatra-resort': 'https://socialsuriname.com/wp-content/uploads/2025/08/Kodoufii-tapawatra-resort-v1.webp',
    'krioro': 'https://socialsuriname.com/wp-content/uploads/2024/06/Krioro-Noord-v1.webp',
    'krioro-north': 'https://socialsuriname.com/wp-content/uploads/2024/06/Krioro-Noord-v1.webp',
    ...
    'las-tias': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/432273552_419251000774454_328283714266259062_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=100&ccb=1-7&_nc_sid=f907e8&_nc_ohc=Y7hFpHwV8y0Q7kNvwHP_eET&_nc_oc=Adr8nP6WjLuAzgFBbpKoH8l-epZX1H-qKj72q4QFcJBbAdj9QdrJtg2XQXih-gOThw8&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=KNZybJubk9A5kc3q_vQ-WA&oh=00_Af4rC9QowGKwxraNDucxozCiuRTOHPmesgGo6chNHv83Ew&oe=6A1C6D41',
    ...
    'max-n-co': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/341877603_641175724508386_4151129468266324299_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=106&ccb=1-7&_nc_sid=f907e8&_nc_ohc=UWCiwUbTD7EQ7kNvwEhnL1a&_nc_oc=Adot9Y085vRsCHlM4DpB9SkdmheKe0OoYE4B3TOpVanhudiIaaN1BdKY-6nZCHyVpmg&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=DWeevJpOAks3ivSgpSEiHg&oh=00_Af4ByM9n7kjnKBQbO2S4T6WVNi3ae3nxVUSroDFdxGjk1w&oe=6A1C6266',
    ...
    'mezze-suriname': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/294898173_733270397960924_646666619644519551_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=102&ccb=1-7&_nc_sid=f907e8&_nc_ohc=bPsd_w_2ypAQ7kNvwHquhQt&_nc_oc=AdqirSYI-vgYkI86pr2qpSwz7ZVlbuDB6gPNYr0UzPurxhRB3rHikDK7Ci8li8AoI_w&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid
_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=Z88ykEiGxigSBK_L6u1PlQ&oh=00_Af4HEhJ1Hq4ur48G2HtAA7V5zbTA6Qmb79UWbpLVevdtug&oe=6A1C652F',
    ...
    'pitbull-fitness': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/409898022_876712084455378_5901037744150437276_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=108&ccb=1-7&_nc_sid=f907e8&_nc_ohc=nPw7q115Yu0Q7kNvwG8dUr7&_nc_oc=AdonEtRgCvC043NiFSe3jhtqkgz51GAytf0KEzDX71qJY6YMfeVnTN51KchG9N0MCu0&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=N3kp_6bAbir2Tz1PpphArA&oh=00_Af7C6yxK4pS6rYsjTVJ_AD_RgbHFhUj2h9_rLa8m95cq7g&oe=6A1C4347',
    'pizza-hut-leysweg': 'https://www.pizzahut.sr/wp-content/uploads/2024/05/pizzahut-logo.png',
    'pizza-hut-south': 'https://www.pizzahut.sr/wp-content/uploads/2024/05/pizzahut-logo.png',
    'pizza-hut-wilhelminastraat': 'https://www.pizzahut.sr/wp-content/uploads/2024/05/pizzahut-logo.png',
    ...
    'qsi-international-school-of-suriname': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/273588828_336908151778927_9195296465908990520_n.png?stp=c109.135.879.879a_dst-png_s200x200&_nc_cat=100&ccb=1-7&_nc_sid=f907e8&_nc_ohc=mdnb4GCI1-EQ7kNvwG17gBy&_nc_oc=AdrN45tanyFVetnDwVCSt9vd8dE_pyvRszfFefm6rH8OindgkeX0q9U032PvSxf6KQw&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=qXzHofMGmpoy8ugiB0eM6g&oh=00_Af4LYTtFvdWf5gYBYuG3sgIDN67169GhFFiw5idJnXeNsA&oe=6A1C4655',
    ...
    'randoe-meubelen': 'https://www.randoe.com/uploads/3/1/6/5/31655579/bar-v3-2.png',
    ...
    'proplan-vastgoed': 'https://exploresuriname.com/images/proplan-vastgoed.webp',
    ...
    'rock-fitness-paramaribo': 'https://scontent.cdninstagram.com/v/t51.2885-19/323927566_2363695813793183_6816847086011728244_n.jpg?stp=dst-jpg_s100x100_tt6&_nc_cat=108&ccb=7-5&_nc_sid=bf7eb4&efg=eyJ2ZW5jb2RlX3RhZyI6InByb2ZpbGVfcGljLnd3dy4zNDcuQzMifQ%3D%3D&_nc_ohc=Td0IhDwyjSEQ7kNvwGEIzdo&_nc_oc=Adoyaew-h90CZwAOCIO-d6icKoKiDL3yfiFmLBNEqkOdVs2EOGeVlkmn58XtaxU3DYk&_nc_zt=24&_nc_ht=scontent.cdninstagram.com&_nc_ss=7ea02&oh=00_Af4BRv3pIf3tXqV7nrE6zasEJidyaEJpGJ1qR5exHLkYjQ&oe=6A1C6933',
    'rogom-farm-nv': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/383348469_733285878810950_4272529358870357972_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=111&ccb=1-7&_nc_sid=f907e8&_nc_ohc=fA5srkm0oMEQ7kNvwECGYQR&_nc_oc=AdpPHgIVKd64HhX2WdlCdQ-uyYrO08uT6x9s19ZOqygzmBOH97Ft_8FpilUK-NIVFaM&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=MciGcouPrOA9WXNkHVMsOg&oh=00_Af6JYDvvygNw0CBYSX6Akabo1uZSdzlL1oe8uqX2aGMnQw&oe=6A1C4187',
    ...
    'subway-2': 'https://newsroom.subway.com/images/header_footer/subway-logo.png',
    'subway-3': 'https://newsroom.subway.com/images/header_footer/subway-logo.png',
    'sugar': 'https://socialsuriname.com/wp-content/uploads/2025/03/Sugar-v1.webp',
    'sun-ice': 'https://www.surinamyp.com/img/sr/a/_1683207522-83-sun-ice-n-v.jpg',
    ...
    'talula': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/309618079_1783012918718850_128590507678347779_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=102&ccb=1-7&_nc_sid=f907e8&_nc_ohc=P2oescCpBkgQ7kNvwG23ZO3&_nc_oc=Adr1CNznA_5_QgmJQZPEED2awyplEFjlJHy79preWgXcWW1Ty2dAd6o9-mq5XvgP2w4&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=FhH_MWPnD575NwR3c57RSg&oh=00_Af5jCEjio2as-xOvmv0CVgRvrnGmbRBlvF_PA-k_YvTHTw&oe=6A1C63AA',
    'taman-indah-resort': 'https://tamanindah.com/wp-content/uploads/2026/04/6307398004_8088be063f_o_4000x2200-1024x563.jpg',
    'tapauku-terras': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/444759569_423856597243024_1240809542841505832_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=103&ccb=1-7&_nc_sid=f907e8&_nc_ohc=HT_z_DLKgfgQ7kNvwHWGxFm&_nc_oc=Ado_a2wd8o49AqPMZ8Lv-6XnONtDYH-z1LQ-iWcgojvvRdcjXrlZ7USNZEAVin1B8wQ&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=XN7U25Crkv5WGRjShdAnSg&oh=00_Af6YAtPW1gAulFVQq-dRGUMaJ6q-Sap4_p3kgfVSFEWAIA&oe=6A1C6EA2',
    ...
    'the-golden-truly-hotel': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/359486558_764974615629780_1925607876079073709_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=101&ccb=1-7&_nc_sid=f907e8&_nc_ohc=3OpWJbnmZ4AQ7kNvwGFItRl&_nc_oc=AdrK0lTAaXcCOQtlVnphIhroJ58OI1bh5gbff4Aay5D1KL2VmI-2lBxkvyn1POA-PvM&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=7lk38GaLBxfcS0rudrvHSw&oh=00_Af5N3cpmy6o6r3dUE8eczVXp81FfEPe-ZQkMyrfUM8AG1A&oe=6A1C51CB',
    'the-laundry-spot': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/702625478_1297988645847530_5895951201015231715_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=108&ccb=1-7&_nc_sid=f907e8&_nc_ohc=Vj47itiMl8cQ7kNvwFPtHtK&_nc_oc=Adp8xEmpgzvYLUYahfxZ2Wa8ivJEwpxyHyJjXN7dSgBOH7-vNQ4hnnHyYwmplbbh_FA&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=jgWbORn3eEf09T8WXdWHhA&oh=00_Af4bssxCSuPI3hWQEdB35ZtIe56XQMh9aXmqUFeUmziuew&oe=6A1C400C',
    ...
    'thermen-hermitage-turkish-bath-beautycenter': 'https://www.surinamyp.com/img/sr/k/_1683719896-96-thermen-hermitage-turkish-bath-beautycenter.jpg',
    ...
    'tori-oso': 'https://www.torioso.com/wp-content/uploads/2024/06/tori-oso-logo-iets.png',
    ...
_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=pVASdWbl2OUeuxdCRRPm6g&oh=00_Af70PeHJfoy6vm8ZFo4Uo8CjO-eMBZBzUfFjKP7gu8mcNQ&oe=6A1C9DE6',
    'percy-massage-therapy': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/293501454_408887077939055_1964587220853993592_n.jpg?stp=c0.0.482.482a_dst-jpg_s200x200_tt6&_nc_cat=101&ccb=1-7&_nc_sid=f907e8&_nc_ohc=n1Bo1t0kMQsQ7kNvwFDNCkP&_nc_oc=AdrVHlWK1GXJmQraTtxsU4lnF9y4UZi0LTy9IirCDMf9bbZQhjdW32568o7EPDDLz1s&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=qk9uUaGWEUKPMwxOOfWX5g&oh=00_Af6zXHTd2X5bikAQm1v6li2DXQNrkpDD6EOB30THLbrM3w&oe=6A1CB0DD',
    'pinkmoon-suriname': 'https://scontent.cdninstagram.com/v/t51.2885-19/422500520_2114538428886791_3168009446201631004_n.jpg?stp=dst-jpg_s100x100_tt6&_nc_cat=111&ccb=7-5&_nc_sid=bf7eb4&efg=eyJ2ZW5jb2RlX3RhZyI6InByb2ZpbGVfcGljLnd3dy43NTEuQzMifQ%3D%3D&_nc_ohc=n4IwqL3KFT4Q7kNvwE6mZVu&_nc_oc=AdpQdqwzn2L6l4gF9Cx6Bqmi8z9g71mMDoEoZ7_2RY6NPmzoosrgyr0WYHMAnaOXreY&_nc_zt=24&_nc_ht=scontent.cdninstagram.com&_nc_ss=7ea02&oh=00_Af4-6ehrkt_FgfB-nBoB2eOaDOsRJJyG0OAE5wMfQEONdA&oe=6A1CB711',
    'the-girl-house': 'https://scontent.forg3-1.fna.fbcdn.net/v/t39.30808-1/292762712_419149746895208_9035747374639862798_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=105&ccb=1-7&_nc_sid=f907e8&_nc_ohc=U0xlKLfS_JYQ7kNvwFzE5ye&_nc_oc=Adph5ZeCu5EYVep9VYGG4wI_Rm-cV9xjcOR60qNyoe78bhrrQ1gnOZXS0K2MfS67o04&_nc_zt=24&_nc_ht=scontent.forg3-1.fna&edm=AKsJ254EAAAA&_nc_gid=jSGz3g0Obpkio1T8Yqet4A&oh=00_Af77gcqMCGf5wZHt4G1bHCB58Hn9DBI22PrFsMpBQ8F0Bw&oe=6A1CABE2',
    ...
    'young-engineers': 'https://exploresuriname.com/images/young-engineers.webp',
    'de-nederlandse-basisschool-het-kleurenorkest': 'https://exploresuriname.com/images/het-kleurenorkest.webp',
    'miniso-gompertstraat': 'https://exploresuriname.com/images/miniso-store.webp',
    'miniso-hermitage-mall': 'https://exploresuriname.com/images/miniso-store.webp',
    'dhl-express-service-point': 'https://exploresuriname.com/images/dhl-express.webp',
...
def _subcat(slug, main_cat=""):
    ...
    if s.startswith(('de-surinaamsche-bank','hakrinbank','republic-bank','finabank','southern-commercial')):
        return 'banking'
    if s.startswith(('digicel','telesur')):
        return 'telecom-utilities'
    if s.startswith(('assuria','fatum')):
        return 'insurance'
    if s.startswith(('da-drogisterij','alis-drugstore','one-stop-apotheek')):
        return 'health-beauty'
    if s.startswith(('digital-world','computronics')):
        return 'electronics'
    if s.startswith('optiek'):
        return 'optical-jewelry'
    if s.startswith(('dojo-couture','footcandy','sash-fashion','steps-','miniso','ochama','crocs','shoebizz')):
        return 'fashion-clothing'
    if s.startswith(('office-world','tomahawk','fish-finder')):
        return 'other'
    if s.startswith('sweetheart') or 'sranan-fowru' in s:
    ...
    _OVERRIDE = {
        ...
        'hes-ds':'fast-food','hes-ds-2':'fast-food','hes-ds-3':'fast-food',
        # retail → Shopping page
        'maze':'fashion-clothing','max-n-co':'fashion-clothing','jjs-place-zuid':'events-party',
        'itrendzz':'electronics','wow-plus':'malls-markets','pandie':'other',
        'mn-international-centrum':'home-furniture','mn-international-kwatta':'home-furniture',
        'chique-eyewear-fashion':'optical-jewelry',
        # beauty clinic vs pharmacy vs vet
        'gaby-april-beauty-clinic':'beauty-wellness',
        'dierenarts-resopawiro':'veterinary','dierenartspraktijk-l-m-bansse-issa':'veterinary',
        'dierenpoli-lobo':'veterinary',
        # drugstores → Shopping health-beauty (match Da Drogisterij)
        'brahma-centrum':'health-beauty','brahma-noord':'health-beauty','brahma-zuid':'health-beauty',
        # misc Services fixes
        'zenobia-bottling-company':'other','kasco-customs-solutions':'legal-professional',
        'ias-wooden-and-construction-nv':'other','stukaderen-in-nederland':'other',
        'buro-workspaces':'other','alliance-francaise':'education',
        'camex-suriname':'banking','h-t':'other','brilleman':'other','yogh-hospitality':'other',
        'balance-studio':'fitness-wellness','invictus-brazilian-jiu-jitsu':'fitness-wellness',
        'padel-x-suriname':'fitness-wellness','mirage-casino':'entertainment',
        'paramaribo-princess-casino':'entertainment','suriname-princess-casino':'entertainment',
    ...
    if any(x in s for x in ['beauty-lounge','wellness-lounge','brow-bliss','shimmery',
            'scene-beauty','delete-beauty','royal-wellness','luxe-escape','han-palace']):
        return 'beauty-wellness'
    if any(x in s for x in ['bar-qle','tipsy','georgies','uitkijk','d-mighty',
        ...
        return 'bars-lounges'
    if any(x in s for x in ['sushi','korean','japanese','teppanyaki','kwan-tai','elev8te',
            'kong-nam','kyu-pho','norrii','ogi-','mingle-sushi','south-america-hot',
            'squeezy-hot','lees-korean','chi-min','sakura',
    ...
    if 'viva-mexico' in s:
        return 'local-caribbean'
    if any(x in s for x in ['orchid','the-perfume-spot','handmade-by-farrell']):
        return 'beauty-wellness'
...
_SUBCAT_SCHEMA = {
    ...
    "veterinary":           ("VeterinaryCare",            None),
...
function renderClues(){for(const d of ['A','D']){const ol=$(d==='A'?'cw-across':'cw-down');ol.innerHTML='';
  P.entries.filter(e=>e.dir===d).sort((a,b)=>a.num-b.num).forEach(e=>{const li=document.createElement('li');li.dataset.k=e.dir+e.num;
    ...
    li.onclick=()=>{dir=e.dir;cur=[e.cells[0][0],e.cells[0][1]];updateActive();if(matchMedia('(pointer:coarse)').matches)$('cw-kb').style.display='block';};ol.appendChild(li);});}
...
function updateActive(){const e=curEntry();if(!e)return;
  ...
  root.querySelectorAll('table.cwgrid td').forEach(td=>{td.classList.remove('word','sel','bad');const r=+td.dataset.r,c=+td.dataset.c;const tx=td.querySelector('.tx');if(tx)tx.textContent=fill[r][c]||'';});
...
_MATCH_LEAGUES = [
    ...
    ("soccer",     "uefa.europa.conf",      "Conference League", "uecl","#0D9488", "foot"),
    ...
    ("soccer",     "conmebol.sudamericana", "Copa Sudamericana", "sud", "#65A30D", "foot"),
    ("soccer",     "concacaf.champions",    "Concacaf Champions Cup", "ccup", "#1E3A8A", "foot"),
    ("soccer",     "concacaf.gold",         "Gold Cup",          "gc",  "#0891B2", "foot"),
    ("soccer",     "concacaf.leagues.cup",  "Leagues Cup",       "lgc", "#7E22CE", "foot"),
    ("soccer",     "usa.1",                 "MLS",               "mls", "#991B1B", "foot"),
...
_CONCACAF_SDP_SEASONS = ("https://api-sdp.concacaf.com/v1/concacaf/football/"
                         ...
                         "662a32386ab045a4af02306872154bea/seasons")  # Caribbean Cup
...
#   {"league": "glory|boxing|svb|sr", "date": "YYYY-MM-DD",
...
_MANUAL_LEAGUES = {
    ...
    "svb":    ("SVB Voetbal",        "#3F6212", "foot"),
    "sr":     ("Suriname Sport Events", "#A16207", "srs"),
}
...
def fetch_sml(cache):
    """Suriname Major League via sml.sr's own JSON API (the public site is a
    JS app; /api/v1 is the feed it renders from). One season call returns the
    full fixture list with kickoff times (UTC), venues, live state and final
    scores. An empty or failed payload never overwrites cached data."""
    label = "Suriname Major League"
    try:
        req = urllib.request.Request("https://sml.sr/api/v1/seasons",
                                     headers={"User-Agent": _BOX_UA})
        with urllib.request.urlopen(req, timeout=15) as r:
            seasons = json.loads(r.read().decode("utf-8")).get("data", [])
        seasons = [s for s in seasons if s.get("start_date")]
        seasons.sort(key=lambda s: s["start_date"], reverse=True)
        if not seasons:
            raise ValueError("no SML seasons in payload")
        ...
        _SX = {"scheduled": "pre", "postponed": "pre", "live": "in",
               "in_progress": "in", "half_time": "in", "paused": "in",
               "finished": "post", "completed": "post", "full_time": "post"}
        evs = []
        for m in ms:
            h, a = m.get("home_team") or {}, m.get("away_team") or {}
            sx = _SX.get((m.get("status") or "").lower(), "pre")
            if sx == "in":
                st = (str(m["minute"]) + "'") if m.get("minute") else "Live"
            else:
                st = "FT" if sx == "post" else ""
            evs.append({"d": (m.get("kick_off_at") or "").replace("+00:00", "Z"),
                        "h": {"n": h.get("name", ""), "l": h.get("badge_url", "") or "",
                              "s": "" if m.get("score_home") is None else str(m["score_home"])},
                        "a": {"n": a.get("name", ""), "l": a.get("badge_url", "") or "",
                              "s": "" if m.get("score_away") is None else str(m["score_away"])},
                        "v": m.get("venue", "") or "",
                        "g": (m.get("matchday") or {}).get("label", "") or "",
                        "st": st, "sx": sx})
        if not evs:
            raise ValueError("SML payload empty")
        print(f"  matches: SML: {len(evs)} fixtures (season {cur.get('name')})")
        out = {"label": label, "events": evs}
        cache["sml"] = out
        return out
    except Exception as exc:
        print(f"  ! SML fetch failed ({exc}); using cached data")
...
def fetch_caribbean(cache):
    ...
    concacaf.com. ESPN has no feed for it. Resolves the newest season, then
    pulls the whole match list in one call."""
    label = "Caribbean Cup"
    try:
        req = urllib.request.Request(_CONCACAF_SDP_SEASONS,
                                     headers={"User-Agent": _BOX_UA})
        with urllib.request.urlopen(req, timeout=15) as r:
        ...
        url = ("https://api-sdp.concacaf.com/v1/concacaf/football/seasons/"
               + sid + "/matches?matchDayId=")
        ...
        for m in ms:
            ...
            evs.append({"d": m.get("matchDateUtc", ""),
                        "h": {"n": h.get("officialName") or h.get("name") or "TBC",
                              "l": "", "s": "" if hs is None else str(hs)},
                        "a": {"n": a.get("officialName") or a.get("name") or "TBC",
                              "l": "", "s": "" if aw is None else str(aw)},
                        "v": ", ".join(x for x in (m.get("stadiumName") or "",
                                                   m.get("cityName") or "") if x),
                        "g": m.get("groupName") or m.get("roundName") or "",
                        "st": "FT" if sx == "post" else "", "sx": sx,
                        "tbc": bool(m.get("isUnknownKickOffTime"))})
        if not evs:
            raise ValueError("Caribbean Cup payload empty")
        print(f"  matches: Caribbean Cup: {len(evs)} fixtures (season {seasons[0].get('seasonName')})")
        out = {"label": label, "events": evs}
        cache["carib"] = out
        return out
    except Exception as exc:
...
def build_matches_page(matches):
    ...
    _GRP_LABELS = [("foot", "Football"), ("bball", "Basketball"), ("fight", "Fight Sports"), ("race", "Motorsport"), ("tennis", "Tennis"), ("srs", "Suriname Events")]
    ...
    _all_lgs = [(lb, k) for k, (lb, _cl, _g) in _EXTRA_LEAGUES.items()] + \
               [(lb, k) for _s, _c, lb, k, _cl, _g in _MATCH_LEAGUES] + \
    ...
    faq = [
        ...
        ("When does Natio play next?",
         ...
         "window; the moment a fixture is official it shows up on this page with its Suriname kickoff time."),
        ...
        ("Are local Suriname matches covered?",
    ...
    hero = _hub_hero("Every kickoff, tip-off and fight night converted",
                     "Sports in Suriname Time",
                     "Natio, the Suriname Major League, world football, NBA and fight nights, "
    ...
    intro = ('<p class="text-gray-500 text-sm mt-2 mb-1">All start times are Suriname time (UTC-3). '
             ...
             'sml.sr and Concacaf. Glory, boxing and other local fixtures are added by hand once confirmed.</p>')
...
def build_korjaal_page():
    """korjaal.html: Korjaal Run - a lane-based endless river runner. Steer a korjaal
    down an endless jungle river, switch between three lanes to dodge logs, rocks and
    sandbanks, scoop up manja to build a multiplier, ride the sula boost and chase a
    high score on a river that never stops speeding up. Canvas-based, touch + keyboard,
    bilingual, everything client-side."""
    import json as _json
    today = datetime.now(SR_TZ).date()
    ...
    _faq = [
        ...
        ("How do I play Korjaal Run?",
         "Swipe or tap the left and right side of the river to switch lanes (arrow keys or A and D also work). "
         "Dodge the logs, rocks and sandbanks, scoop up manja to build your multiplier, and grab a glowing sula "
         "boost to smash straight through everything for a few seconds. The further you paddle, the faster the "
         "river runs."),
        ("How does scoring work?",
         "Your score climbs the further you get and the more manja you collect. Every manja bumps your multiplier, "
         "so a hot streak is worth far more than distance alone. Miss too long and the multiplier cools back down. "
         "Your best score is saved in your browser, so there is always a number to beat."),
        ("Is it free?",
    ...
    _graph = _json.dumps({"@context": "https://schema.org", "@graph": [
        ...
        {"@type": "VideoGame", "@id": SITE_URL + "/korjaal.html#game",
         ...
         "description": "A lane-based endless-runner browser game set on a Surinamese jungle river: switch lanes to dodge logs, rocks and sandbanks, collect manja and ride the sula boost on a river that keeps speeding up.",
    ...
    #kj-cv{display:block;width:100%;border-radius:16px;background:#0d2a20;touch-action:none;user-select:none;-webkit-user-select:none;-webkit-tap-highlight-color:transparent}
    #kj-mute{position:absolute;top:10px;right:10px;width:34px;height:34px;border-radius:9999px;border:none;background:rgba(0,0,0,.38);color:#fff;font-size:15px;line-height:34px;text-align:center;cursor:pointer;z-index:3}
    .lang button{padding:.3rem .8rem;border:1px solid #d1d5db;background:#fff;font-size:.78rem;font-weight:700;color:#6b7280}
    .lang button:first-child{border-radius:9999px 0 0 9999px}.lang button:last-child{border-radius:0 9999px 9999px 0;margin-left:-1px}
    .lang button.on{background:var(--forest);border-color:var(--forest);color:#fff}
    ...
    .kj-stat span{font-size:.64rem;color:#9ca3af;text-transform:uppercase;letter-spacing:.05em}
    .kj-new b{color:var(--forest2,#2f7d4f)}
    .wabtn{display:inline-block;background:#25d366;color:#fff;font-weight:700;border-radius:9999px;padding:.65rem 1.3rem;font-size:.9rem}
    .cpbtn{display:inline-block;background:#fff;border:1px solid #d1d5db;color:#374151;font-weight:700;border-radius:9999px;padding:.65rem 1.3rem;font-size:.9rem;margin-left:.5rem}
    .kj-hint{display:flex;gap:1.1rem;justify-content:center;flex-wrap:wrap;margin-top:.7rem;font-size:.72rem;color:#9ca3af}
    .kj-hint b{color:#6b7280;font-weight:700}
  </style>"""

    head = (PAGE_HEAD
        + '\n  <title>Korjaal Run | Suriname River Runner Game | Explore Suriname</title>'
        + '\n  <meta name="description" content="' + _desc + '">'
        ...
        + '\n  <meta property="og:title" content="' + _title + '">'
        + '\n  <meta property="og:description" content="Switch lanes, dodge the river, ride the sula boost. How far can you paddle before it wins?">'
        + '\n  <meta property="og:image" content="' + _ogimg + '">'
        + '\n  <meta property="og:locale" content="nl_NL">'
        + '\n  <meta property="og:locale:alternate" content="en_US">'
        + '\n  <meta name="twitter:card" content="summary_large_image">'
...
<section class="max-w-2xl mx-auto px-4 mt-14">
  ...
  little tighter.</p>
  <p class="text-gray-700 text-sm leading-relaxed mb-3">Your job is simpler than the boatman's: pick a lane and
  survive. Logs, rocks and sandbanks come at you three lanes wide, the river only gets faster, and a good run is
  all about reading two rows ahead. Grab manja to keep your multiplier hot, and hit a glowing sula boost to blast
  ...
  <a href="crossword.html" class="font-semibold hover:underline" style="color:var(--forest2)">Switi Mini crossword</a>.</p>
    ...
    _noscript = ('<noscript><section class="max-w-2xl mx-auto px-4 mt-6"><p class="text-sm text-gray-600">'
                 'Korjaal Run is a browser game and needs JavaScript. Enable JavaScript to paddle the river.'
                 '</p></section></noscript>')
...
<div class="relative text-white py-12 text-center overflow-hidden" style="background:var(--forest)">
  <div class="relative max-w-3xl mx-auto px-4">
    ...
    <p class="text-white/50 text-xs font-bold uppercase tracking-widest mb-2">Suriname river runner</p>
    <h1 class="serif text-4xl sm:text-5xl font-bold mb-2">Korjaal Run</h1>
    <p class="text-white/70 text-base max-w-xl mx-auto">Pari, pari! Switch lanes, dodge the river and ride the sula. The water keeps getting faster, so how far can you paddle before it wins?</p>
  </div>
</div>
<main class="max-w-xl mx-auto px-4 py-8 pb-20">
...
(function(){
const T={
 en:{score:"Score",best:"Best",dist:"m",manja:"manja",runs:"Runs",tap:"Tap to paddle",again:"Tap to paddle again",over:"The river won.",newbest:"New best!",share:"Share on WhatsApp",copy:"Copy result",copied:"Copied!",hint:"Tap left / right",note:"Switch lanes to dodge logs, rocks and sandbanks. Manja builds your multiplier, the sula boost lets you smash straight through, and the river never stops speeding up. Best score is saved in this browser. Tip: read two rows ahead, not one.",
...
const RL=56,RR=344,RW=RR-RL,LANEW=RW/3;
function laneX(i){return RL+LANEW*(i+0.5);}
const BY=HT*0.76;
...
function sfxSwitch(){beep(560,0.07,"triangle",0.05,720);}
function sfxManja(){beep(680,0.09,"square",0.05,980);}
function sfxBoost(){beep(300,0.35,"sawtooth",0.07,900);}
function sfxNear(){beep(1200,0.05,"sine",0.04);}
function sfxSmash(){beep(150,0.14,"square",0.08,70);}
function sfxCrash(){beep(200,0.5,"sawtooth",0.12,50);}

let st="idle",raf=0,lastT=0;
let boat,obs,manjas,pups,parts,wake,dist,score,speed,mult,multT,manjaCount,runsLocal;
let spawnAt,nextPup,zone,zoneShownT,toast,toastT,shake,boostT,magnetT,started;
function reset(){
 boat={lane:1,x:laneX(1),tilt:0};obs=[];manjas=[];pups=[];parts=[];wake=[];
 dist=0;score=0;speed=200;mult=1;multT=0;manjaCount=0;
 spawnAt=260;nextPup=1900;zone=0;zoneShownT=0;toast=null;toastT=0;shake=0;boostT=0;magnetT=0;
}
function R(a,b){return a+Math.random()*(b-a);}

// ---- spawn a row: guarantee at least one open lane ----
function spawnRow(y){
 const open=Math.floor(Math.random()*3);            // this lane stays clear-ish
 const dens=Math.min(0.72,0.30+dist/38000);         // how likely other lanes are blocked
 for(let l=0;l<3;l++){
  if(l===open){ if(Math.random()<0.45) manjas.push(mkManja(l,y)); continue; }
  if(Math.random()<dens){ obs.push(mkObs(l,y)); }
  else if(Math.random()<0.30){ manjas.push(mkManja(l,y)); }
 }
 // sometimes a line of manja down the open lane (reward for reading ahead)
 if(Math.random()<0.16){ for(let k=1;k<=3;k++) manjas.push(mkManja(open,y-k*46)); }
}
function mkObs(l,y){const r=Math.random();let t="rock";
 if(r<0.42)t="log";else if(r<0.74)t="rock";else t="sand";
 const o={t:t,lane:l,x:laneX(l),y:y,dead:0};
 if(t==="log"){o.w=LANEW*0.92;o.rot=R(-0.25,0.25);}
 else if(t==="rock"){o.r=R(15,22);o.seed=Math.random();}
 else{o.rx=LANEW*0.44;o.ry=R(16,22);}
 return o;}
function mkManja(l,y){return{lane:l,x:laneX(l),y:y,got:0,bob:Math.random()*6};}
function mkPup(){const l=Math.floor(Math.random()*3);
 return{t:Math.random()<0.62?"boost":"magnet",lane:l,x:laneX(l),y:-40,got:0,t0:Date.now()};}

function moveLane(dir){
 if(st!=="run")return;
 const nl=Math.max(0,Math.min(2,boat.lane+dir));
 if(nl!==boat.lane){boat.lane=nl;sfxSwitch();}
}
function say(t,c){toast=t;toastC=c||"#fff";toastT=1.1;}
let toastC="#fff";

// ---------- drawing ----------
const ZTINT=[["#2c5a3f","#356b57"],["#3a5f4a","#4f8a6b"],["#245a52","#2f7d70"],["#5a4a2f","#7a5a3a"],["#1c2f3a","#26414f"]];
function drawBg(){
 const zt=ZTINT[zone%ZTINT.length];
 // jungle banks
 CX.fillStyle=zt[0];CX.fillRect(0,0,W,HT);
 CX.fillStyle="rgba(0,0,0,.18)";
 const sc=(dist*0.5)%40;
 for(let y=-40;y<HT+40;y+=40){const yy=y+sc;
  CX.beginPath();CX.arc(RL-26,yy,20,0,7);CX.arc(RL-6,yy+16,15,0,7);CX.fill();
  CX.beginPath();CX.arc(RR+26,yy+18,20,0,7);CX.arc(RR+6,yy+2,15,0,7);CX.fill();}
 // river
 const g=CX.createLinearGradient(0,0,0,HT);g.addColorStop(0,zt[1]);g.addColorStop(1,zt[0]);
 CX.fillStyle=boostT>0?"#3f7d6c":zt[1];CX.fillRect(RL,0,RW,HT);
 // lane dividers + flow lines (speed)
 CX.strokeStyle="rgba(255,255,255,.10)";CX.lineWidth=2;CX.setLineDash([14,20]);
 const off=(dist*1.3)%34;
 for(let i=1;i<3;i++){CX.beginPath();CX.moveTo(RL+LANEW*i,-off);CX.lineTo(RL+LANEW*i,HT);CX.stroke();}
 CX.setLineDash([]);
 CX.strokeStyle="rgba(255,255,255,.07)";CX.lineWidth=2;
 for(let i=0;i<10;i++){const yy=((dist*2.4+i*90)%(HT+60))-30;const xx=RL+((i*71)%RW);
  CX.beginPath();CX.moveTo(xx,yy);CX.lineTo(xx+2,yy+20);CX.stroke();}
 if(boostT>0){CX.fillStyle="rgba(255,255,255,.22)";
  for(let i=0;i<24;i++){const yy=((dist*4+i*57)%(HT+40))-20,xx=RL+((i*47)%RW);
   CX.beginPath();CX.ellipse(xx,yy,6,2.2,0,0,7);CX.fill();}}
}
function drawObs(o){
 if(o.dead){return;}
 CX.save();CX.translate(o.x,o.y);
 if(o.t==="log"){CX.rotate(o.rot);
  CX.fillStyle="#6f4518";if(CX.roundRect){CX.beginPath();CX.roundRect(-o.w/2,-9,o.w,18,9);CX.fill();}else CX.fillRect(-o.w/2,-9,o.w,18);
  ...
  CX.fillStyle="#8a5a26";CX.beginPath();CX.arc(o.w/2-2,0,7,0,7);CX.fill();}
 else if(o.t==="rock"){const r=o.r;
  CX.fillStyle="rgba(255,255,255,.30)";CX.beginPath();CX.ellipse(0,r*0.8,r*1.3,5,0,0,7);CX.fill();
  CX.fillStyle="#8a8f94";CX.beginPath();CX.moveTo(-r,r*0.4);CX.lineTo(-r*0.4,-r);CX.lineTo(r*0.5,-r*0.7);CX.lineTo(r,r*0.3);CX.closePath();CX.fill();
  CX.fillStyle="#6e7378";CX.beginPath();CX.moveTo(-r*0.4,-r);CX.lineTo(r*0.5,-r*0.7);CX.lineTo(r*0.1,r*0.2);CX.closePath();CX.fill();}
 else{CX.fillStyle="#d9c07f";CX.beginPath();CX.ellipse(0,0,o.rx,o.ry,0,0,7);CX.fill();
  CX.fillStyle="#c8ad69";CX.beginPath();CX.ellipse(0,3,o.rx*0.7,o.ry*0.55,0,0,7);CX.fill();}
 CX.restore();
}
function drawManja(m){if(m.got)return;const y=m.y+Math.sin((dist*0.03)+m.bob)*2;
 CX.save();CX.translate(m.x,y);
 CX.fillStyle="rgba(0,0,0,.15)";CX.beginPath();CX.ellipse(0,11,8,3,0,0,7);CX.fill();
 CX.fillStyle="#f59e0b";CX.beginPath();CX.ellipse(0,0,9,10.5,0.4,0,7);CX.fill();
 CX.fillStyle="#f9c74f";CX.beginPath();CX.ellipse(-2.5,-2.5,4,5,0.4,0,7);CX.fill();
 CX.strokeStyle="#166534";CX.lineWidth=2;CX.beginPath();CX.moveTo(2,-9);CX.quadraticCurveTo(8,-15,10,-11);CX.stroke();
 CX.restore();}
function drawPup(p){if(p.got)return;const pulse=1+Math.sin(Date.now()/140)*0.12;
 CX.save();CX.translate(p.x,p.y);CX.scale(pulse,pulse);
 CX.fillStyle=p.t==="boost"?"rgba(96,220,180,.30)":"rgba(255,200,80,.30)";CX.beginPath();CX.arc(0,0,20,0,7);CX.fill();
 CX.fillStyle=p.t==="boost"?"#34d399":"#fbbf24";CX.beginPath();CX.arc(0,0,14,0,7);CX.fill();
 CX.fillStyle="#0d2a20";
 if(p.t==="boost"){CX.beginPath();CX.moveTo(3,-8);CX.lineTo(-4,1);CX.lineTo(1,1);CX.lineTo(-3,8);CX.lineTo(5,-2);CX.lineTo(0,-2);CX.closePath();CX.fill();}
 else{CX.strokeStyle="#0d2a20";CX.lineWidth=3;CX.beginPath();CX.arc(0,1,6,Math.PI*0.15,Math.PI*0.85,false);CX.stroke();
  CX.fillRect(-7,-3,3,4);CX.fillRect(4,-3,3,4);}
 CX.restore();}
function drawBoat(){const b=boat;CX.save();CX.translate(b.x,BY);CX.rotate(b.tilt*0.5);
 if(boostT>0){CX.fillStyle="rgba(96,220,180,"+(0.25+Math.sin(Date.now()/80)*0.1)+")";CX.beginPath();CX.arc(0,0,30,0,7);CX.fill();}
 CX.fillStyle="rgba(255,255,255,.22)";CX.beginPath();CX.ellipse(0,26,7,10,0,0,7);CX.fill();
 ...
 CX.strokeStyle="#93602e";CX.lineWidth=1;CX.beginPath();CX.moveTo(0,-26);CX.lineTo(0,26);CX.stroke();
 CX.fillStyle="#3b82f6";CX.beginPath();CX.arc(0,4,5,0,7);CX.fill();
 CX.fillStyle="#7c3aed";CX.beginPath();CX.arc(0,-8,4,0,7);CX.fill();
 const side=Math.floor(dist/10)%2?1:-1;
 CX.strokeStyle="#eab308";CX.lineWidth=3;CX.beginPath();CX.moveTo(0,6);CX.lineTo(side*15,14);CX.stroke();
 CX.fillStyle="#eab308";CX.beginPath();CX.ellipse(side*16,16,4,7,side*0.5,0,7);CX.fill();
 CX.restore();}
function drawWake(){wake.forEach(p=>{CX.fillStyle="rgba(255,255,255,"+(p.a*0.4)+")";CX.beginPath();CX.arc(p.x,p.y,p.r,0,7);CX.fill();});}
function drawParts(){parts.forEach(p=>{CX.fillStyle=p.c.replace("A",p.a.toFixed(2));CX.beginPath();CX.arc(p.x,p.y,p.r,0,7);CX.fill();});}
function burst(x,y,col,n){for(let i=0;i<n;i++){const a=R(0,7),s=R(1,4);parts.push({x:x,y:y,vx:Math.cos(a)*s,vy:Math.sin(a)*s-1,r:R(2,5),a:1,c:col});}}

function hud(){const L=T[lang];
 CX.textAlign="center";
 CX.fillStyle="rgba(0,0,0,.28)";if(CX.roundRect){CX.beginPath();CX.roundRect(W/2-70,12,140,42,12);CX.fill();}
 CX.fillStyle="#fff";CX.font="900 30px system-ui";CX.fillText(Math.floor(score).toLocaleString(),W/2,44);
 CX.font="700 11px system-ui";CX.fillStyle="rgba(255,255,255,.7)";CX.fillText(L.score.toUpperCase(),W/2,20);
 // meters + manja pills
 CX.textAlign="left";CX.font="800 13px system-ui";
 CX.fillStyle="rgba(0,0,0,.28)";if(CX.roundRect){CX.beginPath();CX.roundRect(12,64,86,26,8);CX.fill();}
 CX.fillStyle="#fff";CX.fillText(Math.floor(dist/12)+" "+L.dist,22,82);
 CX.textAlign="right";
 CX.fillStyle="rgba(0,0,0,.28)";if(CX.roundRect){CX.beginPath();CX.roundRect(W-104,64,92,26,8);CX.fill();}
 CX.fillStyle="#fbbf24";CX.fillText(manjaCount+" "+L.manja,W-20,82);
 // multiplier badge
 if(mult>1.04){CX.textAlign="center";const s=Math.min(1.35,1+ (mult-1)*0.12);
  CX.save();CX.translate(W/2,104);CX.scale(s,s);
  CX.fillStyle="#f59e0b";CX.font="900 22px system-ui";CX.fillText("x"+mult.toFixed(1),0,0);CX.restore();}
 // boost timer
 if(boostT>0){CX.fillStyle="rgba(52,211,153,.85)";CX.fillRect(W/2-50,116,100*Math.min(1,boostT/5),5);}
 if(magnetT>0){CX.fillStyle="rgba(251,191,36,.85)";CX.fillRect(W/2-50,123,100*Math.min(1,magnetT/6),5);}
 // toast
 if(toastT>0){CX.textAlign="center";CX.globalAlpha=Math.min(1,toastT*1.6);
  CX.font="900 27px system-ui";CX.fillStyle="rgba(0,0,0,.45)";CX.fillText(toast,W/2+2,HT*0.30+2);
  CX.fillStyle=toastC;CX.fillText(toast,W/2,HT*0.30);CX.globalAlpha=1;}
}

// ---------- loop ----------
function step(ts){
 const L=T[lang];
 let dt=(ts-lastT)/1000;if(!lastT)dt=0.016;lastT=ts;if(dt>0.05)dt=0.05;
 const f=dt*60;
 // speed ramp
 let base=200+dist*0.02;if(base>640)base=640;
 speed=base*(boostT>0?1.5:1);
 dist+=speed*dt;
 score+=speed*dt*0.05*mult;
 // multiplier decay
 if(multT>0)multT-=dt;else if(mult>1)mult=Math.max(1,mult-0.35*dt);
 // zones
 const nz=Math.floor(dist/14000);
 if(nz!==zone){zone=nz;say(L.zones[zone%L.zones.length],"#fff");}
 if(Math.floor(dist)===Math.floor(dist/1) && dist>200 && dist<230 && !started){started=1;}
 // spawns
 if(dist>spawnAt){spawnRow(-50);spawnAt=dist+Math.max(120,205-dist/900);}
 if(dist>nextPup){pups.push(mkPup());nextPup=dist+R(2600,4200);}
 // boat lane easing + tilt
 const tx=laneX(boat.lane);boat.tilt+=((tx-boat.x)*0.02-boat.tilt)*0.2;
 boat.x+=(tx-boat.x)*Math.min(1,0.22*f);
 // wake
 if(Math.random()<0.6*f)wake.push({x:boat.x+R(-6,6),y:BY+18,r:R(2,5),a:0.8});
 wake.forEach(p=>{p.y+=speed*dt;p.a-=1.4*dt;p.r+=6*dt;});wake=wake.filter(p=>p.a>0);
 // move + collide obstacles
 for(const o of obs){o.y+=speed*dt;
  if(o.dead)continue;
  const dx=Math.abs(boat.x-o.x),dy=Math.abs(BY-o.y);
  const hx=o.t==="log"?o.w*0.42:o.t==="sand"?o.rx*0.8:(o.r+4);
  const hy=o.t==="log"?12:o.t==="sand"?o.ry*0.75:(o.r+6);
  if(dx<hx+8&&dy<hy+16){
   if(boostT>0){o.dead=1;score+=40*mult;burst(o.x,o.y,"rgba(180,120,60,A)",10);say(L.smash,"#34d399");sfxSmash();shake=6;}
   else{return die();}
  } else if(!o.nm && o.y>BY+hy+16){ // passed us without hit
   o.nm=1;
   if(dx<LANEW*0.95){score+=25*mult;burst(boat.x,BY-18,"rgba(255,255,255,A)",4);if(toastT<=0)say(L.nearmiss,"#a7f3d0");sfxNear();}
  }
 }
 obs=obs.filter(o=>o.y<HT+70);
 // manja
 for(const m of manjas){m.y+=speed*dt;if(m.got)continue;
  if(magnetT>0){const d=Math.hypot(boat.x-m.x,BY-m.y);if(d<120){m.x+=(boat.x-m.x)*Math.min(1,0.18*f);m.y+=(BY-m.y)*Math.min(1,0.18*f);}}
  const dx=Math.abs(boat.x-m.x),dy=Math.abs(BY-m.y);
  if(dx<18&&dy<20){m.got=1;manjaCount++;score+=100*mult;mult=Math.min(9,mult+0.2);multT=3.2;
   burst(m.x,m.y,"rgba(245,180,20,A)",8);sfxManja();}
 }
 manjas=manjas.filter(m=>!m.got&&m.y<HT+40);
 // powerups
 for(const p of pups){p.y+=speed*dt;if(p.got)continue;
  const dx=Math.abs(boat.x-p.x),dy=Math.abs(BY-p.y);
  if(dx<22&&dy<24){p.got=1;
   if(p.t==="boost"){boostT=5;say(L.boost,"#34d399");sfxBoost();shake=8;}
   else{magnetT=6;say(L.magnet,"#fbbf24");sfxBoost();}
   burst(p.x,p.y,"rgba(255,255,255,A)",12);}
 }
 pups=pups.filter(p=>!p.got&&p.y<HT+40);
 if(boostT>0)boostT-=dt;if(magnetT>0)magnetT-=dt;
 if(toastT>0)toastT-=dt;
 // particles
 parts.forEach(p=>{p.x+=p.vx;p.y+=p.vy+speed*dt*0.3;p.vy+=0.15;p.a-=1.6*dt;});parts=parts.filter(p=>p.a>0);
 if(shake>0)shake-=1;
 render();
 raf=requestAnimationFrame(step);
}
function render(){CX.save();if(shake>0||boostT>0){const s=shake>0?shake:1.4;CX.translate(R(-s,s),R(-s,s));}
 drawBg();manjas.forEach(drawManja);obs.forEach(drawObs);pups.forEach(drawPup);drawWake();drawBoat();drawParts();hud();CX.restore();}

function die(){st="over";sfxCrash();shake=10;
 burst(boat.x,BY,"rgba(255,255,255,A)",18);burst(boat.x,BY,"rgba(180,120,60,A)",10);
 render();
...
function shareTxt(sc){
 return "Korjaal Run: "+sc.toLocaleString()+" \\ud83d\\udea3\\n"+Math.floor(dist/12)+" m \\u00b7 "+manjaCount+" manja \\ud83e\\udd6d\\nhttps://exploresuriname.com/korjaal.html";}
function panel(sc,best,isNew){const L=T[lang];
 $("kj-panel").innerHTML='<div class="grid grid-cols-4 gap-2 mb-3">'
  +'<div class="kj-stat'+(isNew?' kj-new':'')+'"><b>'+sc.toLocaleString()+'</b><span>'+L.score+'</span></div>'
  +'<div class="kj-stat"><b>'+best.toLocaleString()+'</b><span>'+L.best+'</span></div>'
  +'<div class="kj-stat"><b>'+Math.floor(dist/12)+'</b><span>'+L.dist+'</span></div>'
  +'<div class="kj-stat"><b>'+manjaCount+'</b><span>'+L.manja+'</span></div></div>'
...
function idle(){st="idle";reset();render();
 ...
 CX.textAlign="center";CX.fillStyle="#fff";CX.font="900 34px system-ui";CX.fillText("Korjaal Run",W/2,HT*0.36);
...
// ---- input ----
let pd=null;
CV.addEventListener("pointerdown",ev=>{ev.preventDefault();pd={x:ev.clientX,y:ev.clientY,t:Date.now()};},{passive:false});
CV.addEventListener("pointerup",ev=>{
 if(!pd)return;const dx=ev.clientX-pd.x,dy=ev.clientY-pd.y;const moved=Math.abs(dx)>24;
 if(st!=="run"){ if(Math.abs(dx)<16&&Math.abs(dy)<16) start(); pd=null; return; }
 if(moved&&Math.abs(dx)>Math.abs(dy)){ moveLane(dx>0?1:-1); }
...
def build_history_page():
    ...
    #tl-hero .ov{position:absolute;inset:0;background:linear-gradient(to bottom,rgba(10,22,16,.88),rgba(10,22,16,.66))}
    ...
    .tl-ev:before{content:"";position:absolute;left:13px;top:8px;width:14px;height:14px;border-radius:9999px;background:var(--ec);border:3px solid #F4ECDA;box-shadow:0 0 0 1.5px var(--ec)}
    ...
    .tl-chips{position:sticky;top:58px;z-index:30;background:linear-gradient(#F4ECDA 82%,rgba(244,236,218,0));scrollbar-width:none;-ms-overflow-style:none}
...
def build_itinerary_page():
    ...
    body += day(4, "Brownsberg to the City",
        ...
        + _ilink("listing/de-gadri/", "De Gadri") + ' or Surinamese classics at '
        + _ilink("listing/tori-oso/", "Tori Oso") + '.')
...
def build_time_page():
    ...
    faq = [
        ("Does Suriname use daylight saving time?",
         ...
         "daylight saving, such as the Netherlands, the United Kingdom and the United States, shift by an hour "
         "twice a year, so the difference to Suriname changes with their seasons, not ours."),
        ("What is the time difference between Suriname and the Netherlands?",
         "The Netherlands is 4 hours ahead of Suriname in its winter (late October to late March) and 5 hours "
         "ahead in its summer. Suriname itself never moves; the gap changes only because the Netherlands puts "
         "its clocks forward for summer time."),
        ("What time zone is Suriname in?",
         "Suriname Time (SRT), UTC&minus;3. It shares this offset with French Guiana, Argentina and the eastern "
         "coast of Brazil. The whole country uses a single time zone."),
        ("Is Suriname the same time as its neighbours?",
         "French Guiana (Cayenne) is on the same time as Suriname, UTC&minus;3. Guyana (Georgetown) is one hour "
    ...
    def _lab(t, fid=""):
        f = (' for="'+fid+'"') if fid else ""
        return ('<label'+f+' class="block text-xs font-semibold uppercase tracking-wide text-gray-500 mb-1">'
                + t + '</label>')
    ...
    body += ('<div class="flex flex-wrap items-center gap-2 mb-4">'
        ...
        '<select id="overlap-city" class="rounded-xl border border-gray-200 px-3 py-2 text-sm bg-white"></select></div>')
    body += '<p id="overlap-note" class="text-gray-600 text-sm mb-4">&nbsp;</p>'
    body += ('<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-3">'
        '<div id="overlap-bar" class="flex gap-px rounded-lg overflow-hidden h-12"></div>'
    ...
    body += ('<div class="flex flex-wrap gap-4 text-xs text-gray-600 mb-12">'
        ...
        '<span class="inline-flex items-center gap-1.5"><span class="inline-block w-3 h-3 rounded-sm" style="background:#E5E7EB"></span>Night somewhere, avoid</span>'
        '<span class="inline-flex items-center gap-1.5"><span class="inline-block w-3 h-3 rounded-sm ring-2" style="background:var(--coral);--tw-ring-color:var(--coral)"></span>Now in Suriname</span>'
        '</div>')
    ...
    rows = [
        ("Netherlands", "Amsterdam", "4 hours ahead in winter, 5 in summer", "Yes"),
        ("United Kingdom", "London", "3 hours ahead in winter, 4 in summer", "Yes"),
        ("France", "Paris", "4 hours ahead in winter, 5 in summer", "Yes"),
        ("US East Coast", "New York, Miami", "2 hours behind in winter, 1 in summer", "Yes"),
        ("Brazil (east)", "S&atilde;o Paulo", "Same time", "No"),
        ("French Guiana", "Cayenne", "Same time", "No"),
        ("Guyana", "Georgetown", "1 hour behind", "No"),
        ("India", "Mumbai", "8 hours 30 minutes ahead", "No"),
        ("China", "Beijing", "11 hours ahead", "No"),
        ("Malaysia", "Kuala Lumpur", "11 hours ahead", "No"),
    ]
    trs = ""
    for place, city, diff, dst in rows:
        trs += ('<tr class="border-b border-gray-100">'
            f'<td class="py-3 pr-4 font-semibold text-gray-900 align-top">{place}<span class="block text-xs font-normal text-gray-400">{city}</span></td>'
            f'<td class="py-3 pr-4 text-gray-700 align-top">{diff}</td>'
            f'<td class="py-3 text-gray-700 align-top">{dst}</td></tr>')
    body += ('<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-12 overflow-x-auto">'
        '<table class="w-full text-sm"><thead><tr class="border-b-2 border-gray-200 text-left">'
        '<th class="py-2 pr-4 font-semibold text-gray-900">Place</th>'
        '<th class="py-2 pr-4 font-semibold text-gray-900">Difference from Suriname</th>'
        '<th class="py-2 font-semibold text-gray-900">Daylight saving?</th></tr></thead>'
...
(function(){
  ...
  var CITIES=[
    ...
    {tz:'Europe/Amsterdam',   label:'Amsterdam',  sub:'Netherlands'},
    ...
    {tz:'Asia/Kolkata',       label:'Mumbai',     sub:'India'},
  ...
  function relDiff(d){ var a=Math.abs(d), u=(a===1?'hour':'hours'); return d===0?'on the same time as Suriname':(d>0? d+' '+u+' ahead of Suriname':a+' '+u+' behind Suriname'); }
  function renderOverlap(){
    var now=new Date();
    var oc=document.getElementById('overlap-city');
    var tz=(oc && oc.value)?oc.value:NL;
    var cityLabel='Amsterdam', countryLabel='the Netherlands';
    for(var i=0;i<CITIES.length;i++){ if(CITIES[i].tz===tz){ cityLabel=CITIES[i].label; countryLabel=CITIES[i].sub; } }
    ...
    if(bar){
      ...
      for(var hh=0; hh<24; hh++){
        var oh=((hh+diff)%24+24)%24;
        var col='#E5E7EB';
        var srDay=(hh>=7 && hh<=22), ocDay=(oh>=7 && oh<=22);
        var srBiz=(hh>=9 && hh<=17), ocBiz=(oh>=9 && oh<=17);
        if(srBiz && ocBiz) col='var(--forest)';
        else if(srDay && ocDay) col='var(--leaf)';
        var ring=(hh===srHour)?';box-shadow:inset 0 0 0 2px var(--coral)':'';
        b+='<div class="flex-1" style="background:'+col+ring+'" title="Suriname '+pad(hh)+':00 = '+cityLabel+' '+pad(oh)+':00"></div>';
      }
      bar.innerHTML=b;
    }
    var dn=document.getElementById('diff-now');
    if(dn){
      var nl2=Math.round((offMin(NL,now)-offMin(SR,now))/60);
      var ny=Math.round((offMin('America/New_York',now)-offMin(SR,now))/60);
      dn.innerHTML='Right now: the Netherlands is '+nl2+' hours ahead of Suriname, and New York is '
        +(ny===0?'on the same time.':(ny>0? ny+' hours ahead.':Math.abs(ny)+' hours behind.'));
    }
  }
  ...
  function tick(){
    var now=new Date();
    var sc=document.getElementById('sr-clock');
    if(sc) sc.textContent=fmt(SR, now, tOpts(true));
    var sd=document.getElementById('sr-date');
    if(sd) sd.textContent=fmt(SR, now, {weekday:'long',day:'numeric',month:'long',year:'numeric'});
    var clocks=document.querySelectorAll('[data-clock]');
    for(var i=0;i<clocks.length;i++){
      var tz=clocks[i].getAttribute('data-clock');
      clocks[i].textContent=fmt(tz, now, tOpts(false));
      var day=document.querySelector('[data-cd="'+tz+'"]');
      if(day){
        var od=fmt(tz, now, {weekday:'short'});
        var here=fmt(SR, now, {weekday:'short'});
        day.textContent=(od===here)?'':od;
      }
    }
  }
  ...
  if(ocSel){
    var oo='';
    for(var oi=0; oi<CITIES.length; oi++){ if(CITIES[oi].home||CITIES[oi].tz==='UTC') continue; oo+='<option value="'+CITIES[oi].tz+'"'+(CITIES[oi].tz===NL?' selected':'')+'>'+CITIES[oi].label+' ('+CITIES[oi].sub+')</option>'; }
    ocSel.innerHTML=oo;
...
"""
    return sw.replace("__TWV__", _TW_V)
